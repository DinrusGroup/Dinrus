                      ...
                      ИКомандаГрафа.Опции опции)
{
  ...
  foreach (i, вершина; граф.вершины)
    выдай.форматнс(`  n{} [label="{}"{}];`, i, вершина.модуль.дайПКН(), (вершина.цикличн_ли ? ",style=filled,fillcolor=tomato" : ""));
  ...
  foreach (край; граф.края)
  {
    ...
    {
      стилиКрая = `[style="`;
      край.статический_ли && (стилиКрая ~= сиСтиль ~ ",");
      край.публичный_ли && (стилиКрая ~= пиСтиль);
