...
public цел HtmlNamedEntity(ткст0 p, т_мера length)
{
    цел tableIndex = tolower(*p) - 'a';
    if (tableIndex >= 0 && tableIndex < 26)
    {
        foreach (entity; namesTable[tableIndex])
        {
            if (entity.имя == p[0 .. length])
                return entity.значение;
        }
    }
    return -1;
}
...
// @todo@ order namesTable and имена? by frequency
const NameId[][] namesTable =
[
...
//  "caps",             0x02229;0x0FE00},  // INTERSECTION with serifs
    ...
    {"копируй",             0x000A9},  // COPYRIGHT SIGN
...
//  "varsubsetneq",     0x0228A;0x0FE00},  // SUBSET OF WITH NOT EQUAL TO - variant with stroke through bottom члены
//  "varsubsetneqq",    0x02ACB;0x0FE00},  // SUBSET OF ABOVE NOT EQUAL TO - variant with stroke through bottom члены
//  "varsupsetneq",     0x0228B;0x0FE00},  // SUPERSET OF WITH NOT EQUAL TO - variant with stroke through bottom члены
//  "varsupsetneqq",    0x02ACC;0x0FE00},  // SUPERSET OF ABOVE NOT EQUAL TO - variant with stroke through bottom члены
...
//  "vsubne",           0x0228A;0x0FE00},  // SUBSET OF WITH NOT EQUAL TO - variant with stroke through bottom члены
//  "vsubnE",           0x02ACB;0x0FE00},  // SUBSET OF ABOVE NOT EQUAL TO - variant with stroke through bottom члены
//  "vsupne",           0x0228B;0x0FE00},  // SUPERSET OF WITH NOT EQUAL TO - variant with stroke through bottom члены
//  "vsupnE",           0x02ACC;0x0FE00},  // SUPERSET OF ABOVE NOT EQUAL TO - variant with stroke through bottom члены
