/**
 * Codeview 4 stuff
 * See "Microsoft Symbol and Тип OMF" document
 *
...
module drc.backend.cv4;

// Online documentation: https://dlang.org/phobos/dmd_backend_cv4.html

const OEM = 0x42;        // Digital Mars OEM number (picked at random)
...
enum
{
    ...
    // D extensions (not используется, causes linker to fail)
    LF_DYN_ARRAY   = 0x17,
    LF_ASSOC_ARRAY = 0x18,
    LF_DELEGATE    = 0x19,
