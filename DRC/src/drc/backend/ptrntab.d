...
version (SCPP) extern (C) ткст0 strlwr( ткст0 s);
...
{
    const PTRNTAB0[1] OPTABLE0 = [ { op, mod }, ];
}

alias  OPTABLE0!(     0x37  ,_i64_bit | _modax) aptb0AAA;
alias  OPTABLE0!(     0xd50a,_i64_bit | _modax) aptb0AAD;
alias  OPTABLE0!(     0xd40a,_i64_bit | _modax) aptb0AAM;
alias  OPTABLE0!(     0x3f,  _i64_bit | _modax) aptb0AAS;
alias  OPTABLE0!(     0x98,_16_bit | _modax) aptb0CBW;
alias  OPTABLE0!(    0x98,_32_bit | _I386 | _modax) aptb0CWDE;
alias  OPTABLE0!(    0x98,_64_bit | _modax) aptb0CDQE;
alias  OPTABLE0!(     0xf8,0) aptb0CLC;
alias  OPTABLE0!(     0xfc,0) aptb0CLD;
alias  OPTABLE0!(     0xfa,0) aptb0CLI;
alias  OPTABLE0!(    0x0f06,0) aptb0CLTS;
alias  OPTABLE0!(     0xf5,0) aptb0CMC;
alias  OPTABLE0!(   0xa6,_modsidi) aptb0CMPSB;
alias  OPTABLE0!(   0xa7,_16_bit | _modsidi) aptb0CMPSW;
//alias  OPTABLE0!( 0xa7,_32_bit | _I386 | _modsidi) aptb0CMPSD;
alias  OPTABLE0!(   0xa7,_64_bit | _modsidi) aptb0CMPSQ;
alias  OPTABLE0!(     0x99, _16_bit | _modaxdx) aptb0CWD;
alias  OPTABLE0!(     0x99,_32_bit | _I386 | _modaxdx) aptb0CDQ;
alias  OPTABLE0!(     0x99, _64_bit | _modaxdx) aptb0CQO;
alias  OPTABLE0!(     0x27,_i64_bit | _modax ) aptb0DAA;
alias  OPTABLE0!(     0x2f,_i64_bit | _modax ) aptb0DAS;
alias  OPTABLE0!(     0xf4,0) aptb0HLT;
alias  OPTABLE0!(    0x6c,_I386 | _modsi) aptb0INSB;
alias  OPTABLE0!(    0x6d,_16_bit | _I386 | _modsi) aptb0INSW;
alias  OPTABLE0!(    0x6d,_32_bit | _I386 | _modsi) aptb0INSD;
alias  OPTABLE0!(    0xce,_i64_bit) aptb0INTO;
alias  OPTABLE0!(    0x0f08,_I386) aptb0INVD;               // Actually a 486 only instruction
alias  OPTABLE0!(    0xcf,_16_bit) aptb0IRET;
alias  OPTABLE0!(   0xcf,_32_bit | _I386) aptb0IRETD;
alias  OPTABLE0!(   0xcf,_64_bit | _I386) aptb0IRETQ;
alias  OPTABLE0!(    0x9f,_modax) aptb0LAHF;
alias  OPTABLE0!(   0xc9,_I386) aptb0LEAVE;
alias  OPTABLE0!(    0xf0,0) aptb0LOCK;
alias  OPTABLE0!(   0xac,_modsiax) aptb0LODSB;
alias  OPTABLE0!(   0xad,_16_bit | _modsiax) aptb0LODSW;
alias  OPTABLE0!(   0xad,_32_bit | _I386 | _modsiax) aptb0LODSD;
alias  OPTABLE0!(   0xad,_64_bit | _modsiax) aptb0LODSQ;
alias  OPTABLE0!(   0xa4, _modsidi) aptb0MOVSB;
alias  OPTABLE0!(   0xa5, _16_bit | _modsidi) aptb0MOVSW;
alias  OPTABLE0!(   0xa5, _64_bit | _modsidi) aptb0MOVSQ;
alias  OPTABLE0!(     0x90, 0) aptb0NOP;
alias  OPTABLE0!(   0x6e, _I386 | _modsi) aptb0OUTSB;
alias  OPTABLE0!(   0x6f, _16_bit | _I386 | _modsi) aptb0OUTSW;
alias  OPTABLE0!(   0x6f, _32_bit | _I386 | _modsi) aptb0OUTSD;
alias  OPTABLE0!(    0x61,_i64_bit | _16_bit | _I386 | _modall) aptb0POPA;
alias  OPTABLE0!(   0x61,_i64_bit | _32_bit | _I386 | _modall) aptb0POPAD;
alias  OPTABLE0!(    0x9d,           _16_bit) aptb0POPF;
alias  OPTABLE0!(   0x9d,_i64_bit | _32_bit | _I386 ) aptb0POPFD;
alias  OPTABLE0!(   0x9d, _64_bit) aptb0POPFQ;
alias  OPTABLE0!(   0x60,_i64_bit | _16_bit | _I386) aptb0PUSHA;
alias  OPTABLE0!(  0x60,_i64_bit | _32_bit | _I386) aptb0PUSHAD;
alias  OPTABLE0!(   0x9c,           _16_bit) aptb0PUSHF;
alias  OPTABLE0!(  0x9c,_i64_bit | _32_bit | _I386) aptb0PUSHFD;
alias  OPTABLE0!(  0x9c, _64_bit) aptb0PUSHFQ;                // TODO REX_W override is implicit
alias  OPTABLE0!(     0xf3, _modcx) aptb0REP;
alias  OPTABLE0!(   0xf2, _modcx) aptb0REPNE;
alias  OPTABLE0!(    0x9e, 0) aptb0SAHF;
alias  OPTABLE0!(   0xAE, _moddi) aptb0SCASB;
alias  OPTABLE0!(   0xAF, _16_bit | _moddi) aptb0SCASW;
alias  OPTABLE0!(   0xAF, _32_bit | _I386 | _moddi) aptb0SCASD;
alias  OPTABLE0!(   0xAF, _64_bit | _moddi) aptb0SCASQ;
alias  OPTABLE0!(     0xf9, 0) aptb0STC;
alias  OPTABLE0!(     0xfd, 0) aptb0STD;
alias  OPTABLE0!(     0xfb, 0) aptb0STI;
alias  OPTABLE0!(   0xaa, _moddi) aptb0STOSB;
alias  OPTABLE0!(   0xAB, _16_bit | _moddi) aptb0STOSW;
alias  OPTABLE0!(   0xAB, _32_bit | _I386 | _moddi) aptb0STOSD;
alias  OPTABLE0!(   0xAB, _64_bit | _moddi) aptb0STOSQ;
alias  OPTABLE0!(    0x9B, 0) aptb0WAIT;
alias  OPTABLE0!(  0x0f09, _I386) aptb0WBINVD;                        // Really a 486 opcode
alias  OPTABLE0!(   0xd7, _modax) aptb0XLATB;
alias  OPTABLE0!(   0x0fa2, _I386 | _modall) aptb0CPUID;
alias  OPTABLE0!(   0x0f32, _I386 | _modaxdx) aptb0RDMSR;
alias  OPTABLE0!(   0x0f33, _I386 | _modaxdx) aptb0RDPMC;
alias  OPTABLE0!(   0x0f31, _I386 | _modaxdx) aptb0RDTSC;
alias  OPTABLE0!(  0x0f01f9, _I386 | _modaxdx | _modcx) aptb0RDTSCP;
alias  OPTABLE0!(   0x0f30, _I386) aptb0WRMSR;
alias  OPTABLE0!(     0x0faa,_i64_bit | _I386) aptb0RSM;
...
PTRNTAB1[3] aptb1INT= /* INT */ [
        { 0xcc, 3,              0 },    // The ulFlags here are meant to
                                        // be the значение of the immediate
                                        // operand
        { 0xcd, 0,              _imm8 },
        { ASM_END }
];
...
alias    OPTABLE_J!(0) aptb1JO;
alias   OPTABLE_J!(1) aptb1JNO;
alias    OPTABLE_J!(2) aptb1JB;
alias   OPTABLE_J!(3) aptb1JNB;
alias    OPTABLE_J!(4) aptb1JZ;
alias   OPTABLE_J!(5) aptb1JNZ;
alias   OPTABLE_J!(6) aptb1JBE;
alias  OPTABLE_J!(7) aptb1JNBE;
alias    OPTABLE_J!(8) aptb1JS;
alias   OPTABLE_J!(9) aptb1JNS;
alias    OPTABLE_J!(0xA) aptb1JP;
alias   OPTABLE_J!(0xB) aptb1JNP;
alias    OPTABLE_J!(0xC) aptb1JL;
alias   OPTABLE_J!(0xD) aptb1JNL;
alias   OPTABLE_J!(0xE) aptb1JLE;
alias  OPTABLE_J!(0xF) aptb1JNLE;
...
alias    OPTABLE_SET!(0) aptb1SETO;
alias    OPTABLE_SET!(1) aptb1SETNO;
alias    OPTABLE_SET!(2) aptb1SETB;
alias    OPTABLE_SET!(3) aptb1SETNB;
alias    OPTABLE_SET!(4) aptb1SETZ;
alias    OPTABLE_SET!(5) aptb1SETNZ;
alias    OPTABLE_SET!(6) aptb1SETBE;
alias    OPTABLE_SET!(7) aptb1SETNBE;
alias    OPTABLE_SET!(8) aptb1SETS;
alias    OPTABLE_SET!(9) aptb1SETNS;
alias    OPTABLE_SET!(0xA) aptb1SETP;
alias    OPTABLE_SET!(0xB) aptb1SETNP;
alias    OPTABLE_SET!(0xC) aptb1SETL;
alias    OPTABLE_SET!(0xD) aptb1SETNL;
alias    OPTABLE_SET!(0xE) aptb1SETLE;
alias    OPTABLE_SET!(0xF) aptb1SETNLE;
...
template OPTABLE_ARITH(opcode_t op, бцел rr, бцел m)
{
    const PTRNTAB2[20] OPTABLE_ARITH =
    [
...
alias  OPTABLE_ARITH!(0x00,_0,0) aptb2ADD;
alias  OPTABLE_ARITH!( 0x08,_1,0) aptb2OR;
alias  OPTABLE_ARITH!(0x10,_2,0) aptb2ADC;
alias  OPTABLE_ARITH!(0x18,_3,0) aptb2SBB;
alias  OPTABLE_ARITH!(0x20,_4,0) aptb2AND;
alias  OPTABLE_ARITH!(0x28,_5,0) aptb2SUB;
alias  OPTABLE_ARITH!(0x30,_6,0) aptb2XOR;
alias  OPTABLE_ARITH!(0x38,_7,_modnot1) aptb2CMP;
...
{
    const PTRNTAB2[9] OPTABLE_SHIFT =
    [
        { 0xd2, op,             _rm8,   _cl },
...
alias   OPTABLE_SHIFT!(_0) aptb2ROL;
alias   OPTABLE_SHIFT!(_1) aptb2ROR;
alias   OPTABLE_SHIFT!(_2) aptb2RCL;
alias   OPTABLE_SHIFT!(_3) aptb2RCR;
alias   OPTABLE_SHIFT!(_4) aptb2SHL;
alias   OPTABLE_SHIFT!(_5) aptb2SHR;
alias   OPTABLE_SHIFT!(_7) aptb2SAR;
...
alias    OPTABLE_CMOV!(0) aptb2CMOVO;
alias    OPTABLE_CMOV!(1) aptb2CMOVNO;
alias    OPTABLE_CMOV!(2) aptb2CMOVB;
alias    OPTABLE_CMOV!(3) aptb2CMOVNB;
alias    OPTABLE_CMOV!(4) aptb2CMOVZ;
alias    OPTABLE_CMOV!(5) aptb2CMOVNZ;
alias    OPTABLE_CMOV!(6) aptb2CMOVBE;
alias    OPTABLE_CMOV!(7) aptb2CMOVNBE;
alias    OPTABLE_CMOV!(8) aptb2CMOVS;
alias    OPTABLE_CMOV!(9) aptb2CMOVNS;
alias    OPTABLE_CMOV!(0xA) aptb2CMOVP;
alias    OPTABLE_CMOV!(0xB) aptb2CMOVNP;
alias    OPTABLE_CMOV!(0xC) aptb2CMOVL;
alias    OPTABLE_CMOV!(0xD) aptb2CMOVNL;
alias    OPTABLE_CMOV!(0xE) aptb2CMOVLE;
alias    OPTABLE_CMOV!(0xF) aptb2CMOVNLE;
...
//
// Floating point instructions which have entirely different флаг
// interpretations
//

alias  OPTABLE0!(    0xd9f0,0) aptb0F2XM1;
alias  OPTABLE0!(     0xd9e1,0) aptb0FABS;
alias  OPTABLE0!(     0xd9e0,0) aptb0FCHS ;
alias  OPTABLE0!(    0xdbe2,_fwait) aptb0FCLEX;
alias  OPTABLE0!(   0xdbe2, _nfwait) aptb0FNCLEX;
alias  OPTABLE0!(   0xded9, 0) aptb0FCOMPP;
alias  OPTABLE0!(     0xd9ff, 0) aptb0FCOS;
alias  OPTABLE0!(  0xdae9, 0) aptb0FUCOMPP;
alias  OPTABLE0!(  0xd9f6, 0) aptb0FDECSTP;
alias  OPTABLE0!(  0xd9f7, 0) aptb0FINCSTP;
alias  OPTABLE0!(    0xdbe3, _fwait) aptb0FINIT;
alias  OPTABLE0!(   0xdbe3, _nfwait) aptb0FNINIT;
alias  OPTABLE0!(     0xdbe0, _fwait) aptb0FENI;
alias  OPTABLE0!(    0xdbe0, _nfwait) aptb0FNENI;
alias  OPTABLE0!(    0xdbe1, _fwait) aptb0FDISI;
alias  OPTABLE0!(   0xdbe1, _nfwait) aptb0FNDISI;
alias  OPTABLE0!(     0xd9e8, 0) aptb0FLD1;
alias  OPTABLE0!(   0xd9e9, 0) aptb0FLDL2T;
alias  OPTABLE0!(   0xd9ea, 0) aptb0FLDL2E;
alias  OPTABLE0!(    0xd9eb, 0) aptb0FLDPI;
alias  OPTABLE0!(   0xd9ec, 0) aptb0FLDLG2;
alias  OPTABLE0!(   0xd9ed, 0) aptb0FLDLN2;
alias  OPTABLE0!(     0xd9ee, 0) aptb0FLDZ;
alias  OPTABLE0!(     0xd9d0, 0) aptb0FNOP;
alias  OPTABLE0!(   0xd9f3, 0) aptb0FPATAN;
alias  OPTABLE0!(    0xd9f8, 0) aptb0FPREM;
alias  OPTABLE0!(   0xd9f5, 0) aptb0FPREM1;
alias  OPTABLE0!(    0xd9f2, 0) aptb0FPTAN;
alias  OPTABLE0!(  0xd9fc, 0) aptb0FRNDINT;
alias  OPTABLE0!(   0xd9fd, 0) aptb0FSCALE;
alias  OPTABLE0!(   0xdbe4, 0) aptb0FSETPM;
alias  OPTABLE0!(     0xd9fe, 0) aptb0FSIN;
alias  OPTABLE0!(  0xd9fb, 0) aptb0FSINCOS;
alias  OPTABLE0!(    0xd9fa, 0) aptb0FSQRT;
alias  OPTABLE0!(     0xd9e4, 0) aptb0FTST;
alias  OPTABLE0!(    0x9b, 0) aptb0FWAIT;
alias  OPTABLE0!(     0xd9e5, 0) aptb0FXAM;
alias  OPTABLE0!(  0xd9f4, 0) aptb0FXTRACT;
alias  OPTABLE0!(    0xd9f1, 0) aptb0FYL2X;
alias  OPTABLE0!(  0xd9f9, 0) aptb0FYL2XP1;
//
// Floating point instructions which have entirely different флаг
...
// for флаг indications
// 10, 11, 12, and 13 indicate that it is a special префикс

// 20, 21, 22, and 23 indicate that this инструкция is a control transfer
//                      and that a new block should be created when this инструкция is
//                      finished. (All Jxx and LOOPxx instructions.)

// 30, 31, 32, 33 are reserved for instructions where the значение of an
...
// используется to select an opcode and then discarded.  The second operand is 0
...
private цел binary(ткст0 p, OP[] table)
{
    цел low = 0;
    сим cp = *p;
    цел high = cast(цел)(table.length) - 1;
    p++;

    while (low <= high)
    {
        const mid = (low + high) >> 1;
        цел cond = table[mid].str[0] - cp;
        if (cond == 0)
        ...
        if (cond > 0)
            ...
            return cast(цел)mid;                 /* match index                  */
    }
    return -1;
}
