...
extern (C) проц out_config_init(
        ...
        ббайт pic,              // position independence уровень (0, 1, 2)
...
static if (TARGET_WINDOS)
{
    ...
    {   config.exe = EX_WIN64;
        ...
        // Not sure we really need these two строки, try removing them later
    ...
    if (exe)
        config.wflags |= WFexe;         // EXE файл only optimizations
