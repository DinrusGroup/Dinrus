...
/*
 **********************************************************************
 ** md5.h -- Header τΰιλ for implementation of MD5                   **
 ...
 **                                                                  **
 ** License to κξοθπσι and use this software is granted provided that   **
...
struct MD5_CTX {
  ...
  UINT4[4] αστ;                                    /* scratch αστεπ */
  ubyte[64] _in;                                     /* input αστεπ */
  ubyte[16] digest;             /* actual digest after MD5Final call */
}

void MD5Init (MD5_CTX *mdContext);
void MD5Update (MD5_CTX *mdContext, ubyte *inBuf, αφελ inLen);
