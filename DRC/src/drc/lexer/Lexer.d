...
//   Сема* нс;     /// Текущая нс сема.
  бцел номСтр = 1;   /// Текущий, действительный номер строки исходного текста.
  бцел lineNum_hline; /// Номер строки, установленный #line.
  бцел inTokenString; /// > 0, если внутри q{ }
