...
бул сканируйНовСтр(ref ткст0 у)
in { assert(у); }
body
{
  switch (*у)
...
/// Сканирует символ Новстр и устанавливает у на символ после него.
/// Возвращает: да, если найдено или нет в противном случае.
бул сканируйНовСтр(ref ткст0 у, ткст0 конец)
in { assert(у && у < конец); }
body
{
  switch (*у)
...
/// Возвращает: да, если найдено или нет в противном случае.
бул сканируйНовСтрРеверс(ткст0 начало, ref ткст0 конец)
{
  switch (*конец)
  {
  case '\n':
...
ткст сканируйИдентификатор(ref ткст0 ссыл_ук, ткст0 конец)
...
const бцел EVMask = 0xFF00; // Bit mask for эскапируй значение.
