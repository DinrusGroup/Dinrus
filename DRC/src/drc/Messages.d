...
static:
  ...
  auto ФайлОтсутствует = "файл модуля отсутствует";
  auto НевернаяВосмеричнаяИскейпПоследовательность = "значение восмеричной последовательности эскапации больше 0xFF: '{}'";
  auto НеверноеИмяМодуля = "имя файла '{}' не может использоваться в качестве имени модуля; является неверным или зарезервированным идентификатором Динрус.";
  // Парсер сообщения:
  ...
  auto НесоответствиеТекстаПостфикса = "у текстового литерала несоответствующий постфиксный символ";
  auto ОжидалсяИдПослеТипаТчк = "ожидался идентификатор после '(Тип).', а не '{}'";
  ...
  auto ОжидалсяЦЧПослеАлайн = "после align ожидалось целое, а не '{}'";
  ...
  auto НеДостаетКэтчИлиВИтоге = "у инструкции try отсутствует тело catch или finally.";
  // Семантичесмкий анализ:
  ...
  auto ОтладкаОпрНаУровнеМодуля = "отладка={} должна быть на уровне модуля";
