...
{ //pragma(сооб, "генТаблицуЧленов()");
  ...
  // FIXME: удали this when dmd issue #2337 has been resolved.
  ...
  т[N.ТУказательНаФункцСи] = ["следщ", "парамы?"];
...
/// Базовый синтаксис:
/// $(PRE
/// Член := МассивДРК | Массив2 | ОпционныйУзел | Узел | Код
/// МассивДРК := Идентификатор "[]"
