...
struct ПарсерЗначенияИдентификатора
{
  ...
  ЗначениеИдентификатора[] разбор(ткст текст)
  {
    ...
    ткст0 началоТела = у, началоСледщТела;
  ...
  static сим[] телоТекста(ткст0 начало, ткст0 конец)
  {
  ...
  бул найдиСледщИдент(ref ткст идент, ref ткст0 началоТела)
  {
    while (у < конецТекста)
    {
      пропустиПробельные();
...
сим[] сделайТекст(ткст0 начало, ткст0 конец)
{
