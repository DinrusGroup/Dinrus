...
#pragma once
#define LLEXPORT __declspec(dllimport)
...
typedef enum {
    ...
    LLVMAtomicOrderingMonotonic = 2, //< guarantees that if you take all the operations affecting a specific address,
    LLVMAtomicOrderingAcquire = 4, //< Acquire provides a barrier of the sort necessary to acquire a lock to access other
                                                                                                           memory with normal loads and stores. 
    LLVMAtomicOrderingRelease = 5,
    LLVMAtomicOrderingAcquireRelease = 6, 
    LLVMAtomicOrderingSequentiallyConsistent = 7 //< provides Acquire semantics                                                                                                                                                                                                                            for loads and Release
} LLVMAtomicOrdering;
