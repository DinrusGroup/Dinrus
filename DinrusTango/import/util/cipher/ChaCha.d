...
class ChaCha : Salsa20
{
    ...
    protected проц salsa20WordToByte(бцел[] ввод, ref ббайт[] вывод)
    {
        ...
        {
            x[ 0] += x[ 4];
            x[12] = Побитно.вращайВлево(x[12]^x[ 0], 16u);
            x[ 8] += x[12];
            x[ 4] = Побитно.вращайВлево(x[ 4]^x[ 8], 12u);
            x[ 0] += x[ 4];
            x[12] = Побитно.вращайВлево(x[12]^x[ 0],  8u);
            x[ 8] += x[12];
            x[ 4] = Побитно.вращайВлево(x[ 4]^x[ 8],  7u);
            x[ 1] += x[ 5];
            x[13] = Побитно.вращайВлево(x[13]^x[ 1], 16u);
            x[ 9] += x[13];
            x[ 5] = Побитно.вращайВлево(x[ 5]^x[ 9], 12u);
            x[ 1] += x[ 5];
            x[13] = Побитно.вращайВлево(x[13]^x[ 1],  8u);
            x[ 9] += x[13];
            x[ 5] = Побитно.вращайВлево(x[ 5]^x[ 9],  7u);
            x[ 2] += x[ 6];
            x[14] = Побитно.вращайВлево(x[14]^x[ 2], 16u);
            x[10] += x[14];
            x[ 6] = Побитно.вращайВлево(x[ 6]^x[10], 12u);
            x[ 2] += x[ 6];
            x[14] = Побитно.вращайВлево(x[14]^x[ 2],  8u);
            x[10] += x[14];
            x[ 6] = Побитно.вращайВлево(x[ 6]^x[10],  7u);
            x[ 3] += x[ 7];
            x[15] = Побитно.вращайВлево(x[15]^x[ 3], 16u);
            x[11] += x[15];
            x[ 7] = Побитно.вращайВлево(x[ 7]^x[11], 12u);
            x[ 3] += x[ 7];
            x[15] = Побитно.вращайВлево(x[15]^x[ 3],  8u);
            x[11] += x[15];
            x[ 7] = Побитно.вращайВлево(x[ 7]^x[11],  7u);
            x[ 0] += x[ 5];
            x[15] = Побитно.вращайВлево(x[15]^x[ 0], 16u);
            x[10] += x[15];
            x[ 5] = Побитно.вращайВлево(x[ 5]^x[10], 12u);
            x[ 0] += x[ 5];
            x[15] = Побитно.вращайВлево(x[15]^x[ 0],  8u);
            x[10] += x[15];
            x[ 5] = Побитно.вращайВлево(x[ 5]^x[10],  7u);
            x[ 1] += x[ 6];
            x[12] = Побитно.вращайВлево(x[12]^x[ 1], 16u);
            x[11] += x[12];
            x[ 6] = Побитно.вращайВлево(x[ 6]^x[11], 12u);
            x[ 1] += x[ 6];
            x[12] = Побитно.вращайВлево(x[12]^x[ 1],  8u);
            x[11] += x[12];
            x[ 6] = Побитно.вращайВлево(x[ 6]^x[11],  7u);
            x[ 2] += x[ 7];
            x[13] = Побитно.вращайВлево(x[13]^x[ 2], 16u);
            x[ 8] += x[13];
            x[ 7] = Побитно.вращайВлево(x[ 7]^x[ 8], 12u);
            x[ 2] += x[ 7];
            x[13] = Побитно.вращайВлево(x[13]^x[ 2],  8u);
            x[ 8] += x[13];
            x[ 7] = Побитно.вращайВлево(x[ 7]^x[ 8],  7u);
            x[ 3] += x[ 4];
            x[14] = Побитно.вращайВлево(x[14]^x[ 3], 16u);
            x[ 9] += x[14];
            x[ 4] = Побитно.вращайВлево(x[ 4]^x[ 9], 12u);
            x[ 3] += x[ 4];
            x[14] = Побитно.вращайВлево(x[14]^x[ 3],  8u);
            x[ 9] += x[14];
            x[ 4] = Побитно.вращайВлево(x[ 4]^x[ 9],  7u);
        }
