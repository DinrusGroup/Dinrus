...
version (TangoTest)
{
    ...
    unittest
    {
        ...
        try
        {
            Ууид.разбор("fecr0a9b-4d5a-439e-8e4b-9d087ff49ba7");
            assert (нет);
        }
        ...
        try
        {
            Ууид.разбор("fec70a9b-4d5a-439e-8e4b-9d087ff49ba");
            assert (нет);
        }
        catch (ИсклНелегальногоАргумента) {}
        ...
        try
        {
            Ууид.разбор("fec70a9b 4d5a-439e-8e4b-9d087ff49ba7");
            assert (нет);
        }
        catch (ИсклНелегальногоАргумента) {}
        ...
        try
        {
            Ууид.разбор("fec70a9b-4d5a-439e-8e4b-9d08-7ff49ba7");
            assert (нет);
        }
        catch (ИсклНелегальногоАргумента) {}
        ...
        try
        {
            Ууид.разбор("fec70a9b-4d5a-439e-8e4b-9d08-ff49ba7");
            assert (нет);
        }
        catch (ИсклНелегальногоАргумента) {}
    }
