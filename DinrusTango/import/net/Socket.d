...
version (Win32)
{
public import sys.WinConsts:
    МАСКА_ВВПАРАМ, ВВК_ВХО,ВВФСБВВ, ДЛИНА_ВСАОПИСАНИЯ, ДЛИНА_ВСАСИС_СТАТУСА, НЕВЕРНСОК, СОКОШИБ, ПОпцияСокета, ППротокол, ПЭкстрЗакрытиеСокета, ПФлагиСокета, ПТипСок;

    private const цел WSAEWOULDBLOCK =  10035;
    private const цел WSAEINTR =        10004;

public import sys.WinStructs:
    ВИНСОКДАН, набор_уд, значврем, хостзап, адрессок, заминка, адрес_ин;



public import sys.WinFuncs:
    закройсок, ВСАСтарт, ВСАЧистка, сокет, адр_инет, ввктлсок, свяжисок, подключи, слушай, закройсок, экстрзак, дайимяпира, дайимясок,  шли, шли_на, пусти, прими, прими_от, выбери, дайопцсок, установиопцсок, дайимяхоста, инетс8а, дайхостпоимени,  дайхостпоадресу, ВСАДайПоследнююОшибку, х8сбк, х8сбц, с8хбк, с8хбц;
