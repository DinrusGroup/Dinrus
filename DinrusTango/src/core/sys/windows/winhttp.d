...
// WinHttpOpen() Flags:
const DWORD WINHTTP_FLAG_ASYNC = 0x10000000;
...
alias  WINHTTP_ASYNC_RESULT* LPWINHTTP_ASYNC_RESULT;
...
alias   URL_COMPONENTS* LPURL_COMPONENTS;
alias   URL_COMPONENTS URL_COMPONENTSW;
alias   URL_COMPONENTS* LPURL_COMPONENTSW;
...
alias  WINHTTP_PROXY_INFO* LPWINHTTP_PROXY_INFO;
alias   WINHTTP_PROXY_INFO WINHTTP_PROXY_INFOW;
alias   WINHTTP_PROXY_INFO* LPWINHTTP_PROXY_INFOW;
...
const DWORD WINHTTP_TIME_FORMAT_BUFSIZE  = 62;
...
const LPCWSTR WINHTTP_NO_PROXY_NAME         = null;
const LPCWSTR WINHTTP_NO_PROXY_BYPASS       = null;

const LPVOID WINHTTP_NO_CLIENT_CERT_CONTEXT = null;

// WinHttp{Query|Set}Option
enum : DWORD {
    WINHTTP_FIRST_OPTION                         = 1,
...
static if (_WIN32_WINNT >= 0x602) {
    const DWORD WINHTTP_LAST_OPTION            = WINHTTP_OPTION_WEB_SOCKET_SEND_BUFFER_SIZE;
} else {    // Windows 7.0A SDK:
    const DWORD WINHTTP_LAST_OPTION            = WINHTTP_OPTION_SERVER_CBT;
}
...
alias WINHTTP_CREDS* PWINHTTP_CREDS;
...
alias  WINHTTP_CREDS_EX* PWINHTTP_CREDS_EX;
...
alias  fnWINHTTP_STATUS_CALLBACK* WINHTTP_STATUS_CALLBACK;
alias WINHTTP_STATUS_CALLBACK* LPWINHTTP_STATUS_CALLBACK;
...
const DWORD WINHTTP_CALLBACK_FLAG_GETPROXYFORURL_COMPLETE  = WINHTTP_CALLBACK_STATUS_GETPROXYFORURL_COMPLETE;

// Windows 8+/2012+
static if (_WIN32_WINNT >= 0x602)   {
  const DWORD WINHTTP_CALLBACK_FLAG_ALL_COMPLETIONS        =  (WINHTTP_CALLBACK_STATUS_SENDREQUEST_COMPLETE
...
const DWORD  WINHTTP_CALLBACK_FLAG_ALL_NOTIFICATIONS      =  0xffffffff;

const WINHTTP_INVALID_STATUS_CALLBACK        = (cast(WINHTTP_STATUS_CALLBACK)(-1L));
...
const LPCWSTR WINHTTP_NO_REFERER             = null;
const LPCWSTR * WINHTTP_DEFAULT_ACCEPT_TYPES = null;
...
const LPCWSTR WINHTTP_NO_ADDITIONAL_HEADERS = null;
const LPVOID WINHTTP_NO_REQUEST_DATA        = null;

const LPCWSTR WINHTTP_HEADER_NAME_BY_INDEX  = null;
const LPVOID WINHTTP_NO_OUTPUT_BUFFER       = null;
const LPDWORD WINHTTP_NO_HEADER_INDEX       = null;
