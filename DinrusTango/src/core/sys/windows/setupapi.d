...
version (Win64)
    private const _alignVal = 0;
else
    private const _alignVal = 1;
...
mixin AlignedStr!(_alignVal, "SP_INF_INFORMATION", "
    DWORD InfStyle;
    DWORD InfCount;
    BYTE[1] _VersionData;
...
mixin AlignedStr!(_alignVal, "FILE_IN_CABINET_INFO_A", "
    PCSTR NameInCabinet;
    DWORD FileSize;
    DWORD Win32Error;
    WORD  DosDate;
...
mixin AlignedStr!(_alignVal, "FILE_IN_CABINET_INFO_W", "
...
mixin AlignedStr!(_alignVal, "SP_DEVICE_INTERFACE_DATA", "
...
mixin AlignedStr!(_alignVal, "SP_DEVICE_INTERFACE_DETAIL_DATA_A", "
...
mixin AlignedStr!(_alignVal, "SP_DEVINFO_LIST_DETAIL_DATA_A", "
...
mixin AlignedStr!(_alignVal, "SP_DEVINFO_LIST_DETAIL_DATA_W", "
...
mixin AlignedStr!(_alignVal, "SP_DRVINFO_DATA_V2_A", "
...
mixin AlignedStr!(_alignVal, "SP_DRVINFO_DATA_V2_W", "
    DWORD           cbSize = SP_DRVINFO_DATA_V2_A.sizeof;
    DWORD           DriverType;
    ULONG_PTR       Reserved;
...
mixin AlignedStr!(_alignVal, "SP_DRVINFO_DETAIL_DATA_W", "
