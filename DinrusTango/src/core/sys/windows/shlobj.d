...
/*
    ...
    UINT fRestFlags : 3;
*/
    bool fShowAllObjects()       { return cast(bool) (_bf & 0x0001); }
    bool fShowExtensions()       { return cast(bool) (_bf & 0x0002); }
    bool fNoConfirmRecycle()     { return cast(bool) (_bf & 0x0004); }
    bool fShowSysFiles()         { return cast(bool) (_bf & 0x0008); }
    bool fShowCompColor()        { return cast(bool) (_bf & 0x0010); }
    bool fDoubleClickInWebView() { return cast(bool) (_bf & 0x0020); }
    bool fDesktopHTML()          { return cast(bool) (_bf & 0x0040); }
    bool fWin95Classic()         { return cast(bool) (_bf & 0x0080); }
    bool fDontPrettyPath()       { return cast(bool) (_bf & 0x0100); }
    bool fShowAttribCol()        { return cast(bool) (_bf & 0x0200); }
    bool fMapNetDrvBtn()         { return cast(bool) (_bf & 0x0400); }
    bool fShowInfoTip()          { return cast(bool) (_bf & 0x0800); }
    bool fHideIcons()            { return cast(bool) (_bf & 0x1000); }
    ubyte fRestFlags()           { return cast(ubyte) (_bf >> 13); }

    bool fShowAllObjects(bool f)       { _bf = cast(ushort) ((_bf & ~0xFFFE) | f);        return f; }
    bool fShowExtensions(bool f)       { _bf = cast(ushort) ((_bf & ~0xFFFD) | (f <<  1)); return f; }
    bool fNoConfirmRecycle(bool f)     { _bf = cast(ushort) ((_bf & ~0xFFFB) | (f <<  2)); return f; }
    bool fShowSysFiles(bool f)         { _bf = cast(ushort) ((_bf & ~0xFFF8) | (f <<  3)); return f; }
    bool fShowCompColor(bool f)        { _bf = cast(ushort) ((_bf & ~0xFFEF) | (f <<  4)); return f; }
    bool fDoubleClickInWebView(bool f) { _bf = cast(ushort) ((_bf & ~0xFFDF) | (f <<  5)); return f; }
    bool fDesktopHTML(bool f)          { _bf = cast(ushort) ((_bf & ~0xFFBF) | (f <<  6)); return f; }
    bool fWin95Classic(bool f)         { _bf = cast(ushort) ((_bf & ~0xFF8F) | (f <<  7)); return f; }
    bool fDontPrettyPath(bool f)       { _bf = cast(ushort) ((_bf & ~0xFEFF) | (f <<  8)); return f; }
    bool fShowAttribCol(bool f)        { _bf = cast(ushort) ((_bf & ~0xFDFF) | (f <<  9)); return f; }
    bool fMapNetDrvBtn(bool f)         { _bf = cast(ushort) ((_bf & ~0xFBFF) | (f << 10)); return f; }
    bool fShowInfoTip(bool f)          { _bf = cast(ushort) ((_bf & ~0xF8FF) | (f << 11)); return f; }
    bool fHideIcons(bool f)            { _bf = cast(ushort) ((_bf & ~0xEFFF) | (f << 12)); return f; }
    ubyte fRestFlags(ubyte f)          { _bf = cast(ushort) ((_bf & ~0x1FFF) | (f << 13)); return cast(ubyte) (f & 7); }
}
...
static if (_WIN32_WINNT >= 0x500) {
    ...
    */
        bool fShowAllObjects()       { return cast(bool) (_bf1 & 0x00000001); }
        bool fShowExtensions()       { return cast(bool) (_bf1 & 0x00000002); }
        bool fNoConfirmRecycle()     { return cast(bool) (_bf1 & 0x00000004); }
        bool fShowSysFiles()         { return cast(bool) (_bf1 & 0x00000008); }
        bool fShowCompColor()        { return cast(bool) (_bf1 & 0x00000010); }
        bool fDoubleClickInWebView() { return cast(bool) (_bf1 & 0x00000020); }
        bool fDesktopHTML()          { return cast(bool) (_bf1 & 0x00000040); }
        bool fWin95Classic()         { return cast(bool) (_bf1 & 0x00000080); }
        bool fDontPrettyPath()       { return cast(bool) (_bf1 & 0x00000100); }
        bool fShowAttribCol()        { return cast(bool) (_bf1 & 0x00000200); }
        bool fMapNetDrvBtn()         { return cast(bool) (_bf1 & 0x00000400); }
        bool fShowInfoTip()          { return cast(bool) (_bf1 & 0x00000800); }
        bool fHideIcons()            { return cast(bool) (_bf1 & 0x00001000); }
        bool fWebView()              { return cast(bool) (_bf1 & 0x00002000); }
        bool fFilter()               { return cast(bool) (_bf1 & 0x00004000); }
        bool fShowSuperHidden()      { return cast(bool) (_bf1 & 0x00008000); }
        bool fNoNetCrawling()        { return cast(bool) (_bf1 & 0x00010000); }

        bool fShowAllObjects(bool f)       { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFFE) | f);         return f; }
        bool fShowExtensions(bool f)       { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFFD) | (f <<  1)); return f; }
        bool fNoConfirmRecycle(bool f)     { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFFB) | (f <<  2)); return f; }
        bool fShowSysFiles(bool f)         { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFF8) | (f <<  3)); return f; }
        bool fShowCompColor(bool f)        { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFEF) | (f <<  4)); return f; }
        bool fDoubleClickInWebView(bool f) { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFDF) | (f <<  5)); return f; }
        bool fDesktopHTML(bool f)          { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFFBF) | (f <<  6)); return f; }
        bool fWin95Classic(bool f)         { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFF8F) | (f <<  7)); return f; }
        bool fDontPrettyPath(bool f)       { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFEFF) | (f <<  8)); return f; }
        bool fShowAttribCol(bool f)        { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFDFF) | (f <<  9)); return f; }
        bool fMapNetDrvBtn(bool f)         { _bf1 = cast(uint) ((_bf1 & ~0xFFFFFBFF) | (f << 10)); return f; }
        bool fShowInfoTip(bool f)          { _bf1 = cast(uint) ((_bf1 & ~0xFFFFF8FF) | (f << 11)); return f; }
        bool fHideIcons(bool f)            { _bf1 = cast(uint) ((_bf1 & ~0xFFFFEFFF) | (f << 12)); return f; }
        bool fWebView(bool f)              { _bf1 = cast(uint) ((_bf1 & ~0xFFFFDFFF) | (f << 13)); return f; }
        bool fFilter(bool f)               { _bf1 = cast(uint) ((_bf1 & ~0xFFFFBFFF) | (f << 14)); return f; }
        bool fShowSuperHidden(bool f)      { _bf1 = cast(uint) ((_bf1 & ~0xFFFF8FFF) | (f << 15)); return f; }
        bool fNoNetCrawling(bool f)        { _bf1 = cast(uint) ((_bf1 & ~0xFFFEFFFF) | (f << 16)); return f; }
    /*
        BOOL fSepProcess : 1;
        ...
        UINT fSpareFlags : 13;
    */
        bool fSepProcess()           { return cast(bool) (_bf2 & 0x00000001); }
        bool fStartPanelOn()         { return cast(bool) (_bf2 & 0x00000002); }
        bool fShowStartPage()        { return cast(bool) (_bf2 & 0x00000004); }
        ushort fSpareFlags()         { return cast(ushort) ((_bf2 & 0x0000FFF8) >> 3); }

        bool fSepProcess(bool f)     { _bf2 = cast(uint) ((_bf2 & ~0xFFFFFFFE) | f);        return f; }
        bool fStartPanelOn(bool f)   { _bf2 = cast(uint) ((_bf2 & ~0xFFFFFFFD) | (f << 1)); return f; }
        bool fShowStartPage(bool f)  { _bf2 = cast(uint) ((_bf2 & ~0xFFFFFFFB) | (f << 2)); return f; }
        ushort fSpareFlags(ushort f) {
