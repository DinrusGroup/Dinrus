...
/*******************************************************************************
        ...
        Convert текст в_ and является Windows 'код pages'. This is non-portable,
...
struct КодоваяСтраница
{
    ...
    **********************************************************************/
    ...
    static ткст является (ткст ист, ткст приёмн, бцел страница=0)
    {
    ...
    **********************************************************************/
    ...
    private static ткст преобразуй (ткст ист, ткст приёмн, бцел является, бцел преобр_в)
    {
        бцел длин = 0;
        ...
        if (ист.length > 0)
        {
            ...
            длин = MultiByteToWideChar (является, 0, cast(PCHAR)ист.ptr, ист.length,
...
debug(Test)
{
    проц main ()
    {
        ...
        s = КодоваяСтраница.является (s, x);
    }
}
