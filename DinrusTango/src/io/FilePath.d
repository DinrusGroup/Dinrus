...
class ФПуть : ПросмотрПути
{
    ...
    ***********************************************************************/
    ...
    {
        auto x = исправь (p.folder_, p.имя_, p.имя_ - p.folder_, псеп_в_конце (другой));
        p.suffix_ += x;
        p.имя_ += x;
        return this;
    }
    ...
    ***********************************************************************/
    ...
    {
        auto x = исправь (p.имя_, p.suffix_, p.suffix_ - p.имя_, другой);
        p.suffix_ += x;
        return this;
    }
    ...
    ***********************************************************************/
    ...
    {
        исправь (p.имя_, p.end_, p.end_ - p.имя_, другой);
        return разбор;
    }
