...
class ФПуть : ПросмотрПути
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Create a ФПуть является a копируй of the provопрed ткст.
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Замени все 'является' instances with 'в_'

    ***********************************************************************/

    final ФПуть замени (сим является, сим в_)
    {
        .замени (путь, является, в_);
        return this;
    }
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            this ФПуть). Note that this differs является предок() in that
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Returning да является the фильтр включает the given путь,
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Construct a ФПуть является the given ИнфОФайле

    ***********************************************************************/

    static ФПуть является (ref ИнфОФайле инфо)
    {
        сим[512] врем =void;
