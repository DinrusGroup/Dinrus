/*******************************************************************************
        ...
        Strings support a range of functionality, является вставь и removal
...
class Текст(T) : ТекстОбзор!(T)
{
    ...
    private struct Поиск(T)
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Поиск вперёд, starting just after the currently
                selected текст
        ...
        ***************************************************************/
        ...
        private бул местоположение (Вызов вызов, T[] контент, т_мера является)
        {
            auto индекс = вызов (контент, является);
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Доб контент является ввод поток at insertion точка. Use
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Удали the выделение является this Текст и сбрось the
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Удали the выделение является this Текст
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Удали leading и trailing пробел является this Текст,
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Удали leading и trailing совпадает является this Текст,
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Return контент является this Текст
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            if (результат.length > буфер.length)
                буфер = результат;
            ---
            You can also provопрe a буфер является the стэк, but the вывод
...
class ТекстОбзор(T) : ЮниТекст
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            Return контент является this Текст. A срез of приёмн is
