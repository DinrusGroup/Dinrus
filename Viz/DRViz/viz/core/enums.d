...
enum DialogResult: int
{
	...
	ABORT = IDABORT,
	IGNORE = IDIGNORE,
	CLOSE = CANCEL, //Uguale а 'CANCEL'
}

enum DockStyle: ббайт
{
	NONE 	= 0,
	LEFT 	= 1,
	TOP 	= 2,
...
enum Keys: uint // docmain
{
	...
	KANA_MODE = 21, ///
	KANJI_MODE = 25, ///
	LEFT_КОНТРОЛ = 162, /// Left Ctrl.
	LEFT = 37, /// Left стрелка.
	LINE_FEED = 10, ///
	...
	PRINT_SCREEN = 44, ///
	PROCESS_KEY = 229, ///
	RIGHT_КОНТРОЛ = 163, /// Right Ctrl.
	RETURN = 13, ///
	RIGHT = 39, /// Right стрелка.
	...
	/// Bit mask to extract модификаторы from key value.
