...
class ProgressBar: SubclassedControl
{
	...
	public void minRange(uint mr)
	{
		...
		if(this.created)
		{
			this.шлиСооб(PBM_SETRANGE32, this._minRange, this._maxRange);
		}
	}
	...
	public void step(uint s)
	{
		...
		if(this.created)
		{
			this.шлиСооб(PBM_SETSTEP, this._step, 0);
		}
	}
	...
	public uint position()
	{
		if(this.created)
		{
			return this.шлиСооб(PBM_GETPOS, 0, 0);
		}
