...
module viz.common;
public import winapi, stdrus, cidrus, sys.DStructs, sys.DConsts, tpl.all, tpl.stream, viz.consts, viz.iface, viz.event, viz.graphics, viz.structs, viz.collections, sys.DFuncs, sys.DIfaces: ПотокВвода, ПотокВывода;
...
alias ТипВозврата!(Объект.opEquals) т_равно; 
...
export class ВизКомОбъект: ComObject // package
{
	extern(Windows):
