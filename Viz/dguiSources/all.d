 ...
 *
 * Версия	DLL				Distribution Platform
 * -------  --------------  -----------------------
 * 4.0		All				Windows 95 and Windows NT 4.0
 * 4.7		All				Windows Internet Explorer 3.ш
 ...
 * with все Internet Explorer releases. Shlwapi.dll shipped with Internet Explorer 4.0, 
 * so its initial version number here is 4.71. The Shell was not updated with the Internet Explorer 3.0 release, 
 * so Shell32.dll does not have а version 4.70. 
 ...
 * In general, you should assume that все three DLLs may have different version numbers, 
 ...
 * version 4.71 or 4.72 of Comctl32.dll or Shlwapi.dll on а system does not guarantee that Shell32.dll 
 * has the same version number. All Windows 98 systems have version 4.72 of Shell32.dll.
 *
 * NOTE 3
 * Версия 5.80 of Comctl32.dll and version 5.0 of Shlwapi.dll are distributed with Internet Explorer 5. 
 * They will be found on все systems on which Internet Explorer 5 is installed, except Windows 2000. 
 ...
 * Версия 5.0 of Shell32.dll will be distributed with Windows 2000 and Windows Me, 
...
public import dgui.form, dgui.кнопка, dgui.label, dgui.textbox, dgui.richtextbox, dgui.panel, dgui.tabcontrol, 
