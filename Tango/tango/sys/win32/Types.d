module drTango.sys.win32.Types;
...
alias DWORD (*EDITПотокCALLBACK)(DWORD, LPBYTE, LONG, LONG);
...
const 
{
 ...
 LPCTSTR SE_TAKE_OWNERSHИП_NAME = ("SeTakeOwnershИПPrivilege");
...
enum : DWORD 
{
 ...
 ERROR_PИПE_CONNECTED = (535),
 ERROR_PИПE_LISTENING = (536),
 ...
 ERROR_BAD_DESCRИПTOR_FORMAT = (1361),
 ...
 ERROR_POУПП_ALREADY_ACTIVE = (1446),
 ...
 ERROR_TRUSTED_RELATIONSHИП_FAILURE = (1789),
 ...
 ERROR_CLИПPING_NOT_SUPPORTED = (2005),
 ...
 FILE_CREATE_PИПE_INSTANCE = (0x0004),
 FILE_READ_EA = (0x0008),
 ...
 CLИП_DEFAULT_PRECIS = (0),
 CLИП_CHARACTER_PRECIS = (1),
 CLИП_STROKE_PRECIS = (2),
 CLИП_MASK = (15),
 CLИП_LH_ANGLES = (16),
 CLИП_TT_ALWAYS = (32),
 CLИП_EMBEDDED = (128),
 ...
 CMB_MASKED = (2),
 PИПE_ACCESS_DUPLEX = (3),
 PИПE_ACCESS_INBOUND = (1),
 PИПE_ACCESS_OUTBOUND = (2),
 WRITE_DAC = (0x40000),
 WRITE_OWNER = (0x80000),
 ACCESS_SYSTEM_SECURITY = (0x1000000),
 PИПE_TYPE_BYTE = (0),
 PИПE_TYPE_MESSAGE = (4),
 PИПE_READMODE_BYTE = (0),
 PИПE_READMODE_MESSAGE = (2),
 PИПE_WAIT = (0),
 PИПE_NOWAIT = (1),
 PS_GEOMETRIC = (65536),
 PS_COSMETIC = (0),
 ...
 WS_CLИПCHILDREN = (0x2000000),
 WS_CLИПSIBLINGS = (0x4000000),
 ...
 CBS_OEMCONVERT = (0x80),
 CBS_OWNERDНеобрFIXED = (0x10),
 CBS_OWNERDНеобрVARIABLE = (0x20),
 CBS_SIMPLE = (0x1),
 CBS_SORT = (0x100),
 ...
 LBS_NOSEL = (0x4000),
 LBS_NOTIFY = (0x1),
 LBS_OWNERDНеобрFIXED = (0x10),
 LBS_OWNERDНеобрVARIABLE = (0x20),
 LBS_SORT = (0x2),
 ...
 DT_CENTER = (1),
 DT_EDITCONTROL = (8192),
 DT_END_ELLИПSIS = (32768),
 DT_PATH_ELLИПSIS = (16384),
 DT_EXPANDTABS = (64),
 ...
 DCX_CACHE = (0x2),
 DCX_PARENTCLИП = (0x20),
 DCX_CLИПSIBLINGS = (0x10),
 DCX_CLИПCHILDREN = (0x8),
...
enum : DWORD 
{
 ...
 SECURITY_DESCRИПTOR_REVISION = (1),
...
*/
 ...
 REG_EXPAND_SZ = (2),
 REG_FULL_RESOURCE_DESCRИПTOR = (9),
 REG_LINK = (6),
 REG_MULTI_SZ = (7),
 REG_Неук = (0),
 REG_RESOURCE_LIST = (8),
 ...
 LOCALE_ИПOSSIGNPOSN = (82),
 LOCALE_INEGSIGNPOSN = (83),
 LOCALE_ИПOSSYMPRECEDES = (84),
 LOCALE_ИПOSSEPBYSPACE = (85),
 ...
 SPIF_ОтправкаWININICHANGE = (2),
 SPIF_ОтправкаCHANGE = (2),
 TPM_CENTERALIGN = (0x4),
 TPM_LEFTALIGN = (0),
 TPM_RIGHTALIGN = (0x8),
 TPM_LEFTBUTTON = (0),
 ...
 BACKUP_LINK = (5),
 Поток_MODIFIED_WHEN_READ = (1),
 Поток_CONTAINS_SECURITY = (2),
...
char* TOOLTИПS_CLASSW = ("tooltИПs_class32");
...
char* TOOLTИПS_CLASSA = ("tooltИПs_class32");
...
char* TOOLTИПS_CLASS = (TOOLTИПS_CLASSA);
...
enum : DWORD 
{
 ...
 PROCESSOR_MИПS_R4000 = (4000),
 PROCESSOR_ALPHA_21064 = (21064),
 COMPRESSION_FORMAT_Неук = (0),
 ...
 SECURITY_DESCRИПTOR_MIN_LENGTH = (20),
 ...
 CF_SCREENFONTS = (0x1),
 CF_SCRИПTSONLY = (0x400),
 CF_SELECTSCRИПT = (0x400000),
 CF_SHOWHELP = (0x4),
 CF_USESTYLE = (0x80),
 CF_WYSIWYG = (0x8000),
 BOLD_FONTTYPE = (0x100),
...
enum : DWORD 
{
 ...
 BI_RLE4 = (2),
 BI_BITFIELDS = (3),
 PFD_DНеобр_TO_WINDOW = (0x4),
 PFD_DНеобр_TO_BITMAP = (0x8),
 ...
 DMLERR_INVALКСЕРARAMETER = (0x4006),
 ...
 TTM_UPDATETИПTEXT = (TTM_UPDATETИПTEXTA),
 ...
 WM_DELETEITEM = (45),
 WM_DESTROY = (2),
 WM_DESTROYCLИПBOARD = (775),
 WM_DEVICECHANGE = (537),
 WM_DEVMODECHANGE = (27),
 WM_DISPLAYCHANGE = (126),
 WM_DНеобрCLИПBOARD = (776),
 WM_DНеобрITEM = (43),
 WM_DROPFILES = (563),
 WM_ENABLE = (10),
 WM_ENDSESSION = (22),
...
alias RGBTRИПLE TAGRGBTRИПLE;
alias RGBTRИПLE TRGBTRИПLE;
alias RGBTRИПLE* PRGBTRИПLE;

struct BITMAPCOREINFO
{
 BITMAPCOREHEADER bmciHeader;
 RGBTRИПLE[1 + 0] bmciColors;
}
...
alias CIEXYZTRИПLE TAGCIEXYZTRИПLE;
alias CIEXYZTRИПLE* LPCIEXYZTRИПLE;
alias CIEXYZTRИПLE TCIEXYZTRИПLE;
alias CIEXYZTRИПLE* PCIEXYZTRИПLE;
...
struct COMMTIMEOUTS
{
 ...
 DWORD ReadTotalTimeoutMultИПlier;
 DWORD ReadTotalTimeoutConstant;
 DWORD WriteTotalTimeoutMultИПlier;
...
//
 ...
 CONTEXT_CONTROL =   (CONTEXT_i386 | 0x00000001), // SS:SP, CS:ИП, FLAGS, BP
...
alias RИП_INFO _RИП_INFO;
alias RИП_INFO TRИПINFO;
alias RИП_INFO* PRИПINFO;
...
alias DНеобрITEMSTRUCT* LPDНеобрITEMSTRUCT;
alias DНеобрITEMSTRUCT TAGDНеобрITEMSTRUCT;
alias DНеобрITEMSTRUCT TDНеобрITEMSTRUCT;
alias DНеобрITEMSTRUCT* PDНеобрITEMSTRUCT;

struct DНеобрTEXTPARAMS
{
 UINT cbSize;
 int iTabLength;
 int iLeftMargin;
 int iRightMargin;
 UINT uiLengthDНеобрn;
}

alias DНеобрTEXTPARAMS* LPDНеобрTEXTPARAMS;
alias DНеобрTEXTPARAMS TDНеобрTEXTPARAMS;
alias DНеобрTEXTPARAMS* PDНеобрTEXTPARAMS;
...
struct EDITПоток
{
 DWORD dwCookie;
 DWORD dwError;
 EDITПотокCALLBACK pfnCallback;
}

alias EDITПоток _EDITПоток;
alias EDITПоток TEDITПоток;
alias EDITПоток* PEDITПоток;
...
alias EMRELLИПSE TAGEMRELLИПSE;
alias EMRELLИПSE TEMRELLИПSE;
alias EMRELLИПSE* PEMRELLИПSE;
alias EMRELLИПSE EMRRECTANGLE;
alias EMRELLИПSE TEMRRECTANGLE;
alias EMRELLИПSE* PEMRRECTANGLE;
...
struct EMREXCLUDECLИПRECT
{
 EMR emr;
 RECTL rclClИП;
}

alias EMREXCLUDECLИПRECT TAGEMREXCLUDECLИПRECT;
alias EMREXCLUDECLИПRECT TEMREXCLUDECLИПRECT;
alias EMREXCLUDECLИПRECT* PEMREXCLUDECLИПRECT;
alias EMREXCLUDECLИПRECT EMRINTERSECTCLИПRECT;
alias EMREXCLUDECLИПRECT TEMRINTERSECTCLИПRECT;
alias EMREXCLUDECLИПRECT* PEMRINTERSECTCLИПRECT;
...
alias EMREXTSELECTCLИПRGN TAGEMREXTSELECTCLИПRGN;
alias EMREXTSELECTCLИПRGN TEMREXTSELECTCLИПRGN;
alias EMREXTSELECTCLИПRGN* PEMREXTSELECTCLИПRGN;
...
struct EMROFFSETCLИПRGN
{
 EMR emr;
 POINTL ptlOffset;
}

alias EMROFFSETCLИПRGN TAGEMROFFSETCLИПRGN;
alias EMROFFSETCLИПRGN TEMROFFSETCLИПRGN;
alias EMROFFSETCLИПRGN* PEMROFFSETCLИПRGN;
...
alias EMRPOLYDНеобр TAGEMRPOLYDНеобр;
alias EMRPOLYDНеобр TEMRPOLYDНеобр;
alias EMRPOLYDНеобр* PEMRPOLYDНеобр;

struct EMRPOLYDНеобр16
{
 EMR emr;
 RECTL rclBounds;
 DWORD cpts;
...
alias EMRPOLYDНеобр16 TAGEMRPOLYDНеобр16;
alias EMRPOLYDНеобр16 TEMRPOLYDНеобр16;
alias EMRPOLYDНеобр16* PEMRPOLYDНеобр16;
...
struct EMRSELECTCLИПPATH
{
 EMR emr;
 DWORD iMode;
}

alias EMRSELECTCLИПPATH TAGEMRSELECTCLИПPATH;
alias EMRSELECTCLИПPATH TEMRSELECTCLИПPATH;
alias EMRSELECTCLИПPATH* PEMRSELECTCLИПPATH;
alias EMRSELECTCLИПPATH EMRSETBKMODE;
alias EMRSELECTCLИПPATH TEMRSETBKMODE;
alias EMRSELECTCLИПPATH* PEMRSETBKMODE;
alias EMRSELECTCLИПPATH EMRSETMAPMODE;
alias EMRSELECTCLИПPATH TEMRSETMAPMODE;
alias EMRSELECTCLИПPATH* PEMRSETMAPMODE;
alias EMRSELECTCLИПPATH EMRSETPOLYFILLMODE;
alias EMRSELECTCLИПPATH TEMRSETPOLYFILLMODE;
alias EMRSELECTCLИПPATH* PEMRSETPOLYFILLMODE;
alias EMRSELECTCLИПPATH EMRSETROP2;
alias EMRSELECTCLИПPATH TEMRSETROP2;
alias EMRSELECTCLИПPATH* PEMRSETROP2;
alias EMRSELECTCLИПPATH EMRSETSTRETCHBLTMODE;
alias EMRSELECTCLИПPATH TEMRSETSTRETCHBLTMODE;
alias EMRSELECTCLИПPATH* PEMRSETSTRETCHBLTMODE;
alias EMRSELECTCLИПPATH EMRSETTEXTALIGN;
alias EMRSELECTCLИПPATH TEMRSETTEXTALIGN;
alias EMRSELECTCLИПPATH* PEMRSETTEXTALIGN;
alias EMRSELECTCLИПPATH EMRENABLEICM;
alias EMRSELECTCLИПPATH TEMRENABLEICM;
alias EMRSELECTCLИПPATH* PEMRENABLEICM;
...
alias ENSAVECLИПBOARD TENSAVECLИПBOARD;
alias ENSAVECLИПBOARD* PENSAVECLИПBOARD;
...
struct ENUMLOGFONTEXA {
 ...
 BYTE   elfFullName[LF_FULLFACESIZE];
 BYTE   elfStyle[LF_FACESIZE];
 BYTE   elfScrИПt[LF_FACESIZE];
}
struct ENUMLOGFONTEXW {
 LOGFONTW  elfLogFont;
 WCHAR  elfFullName[LF_FULLFACESIZE];
 WCHAR  elfStyle[LF_FACESIZE];
 WCHAR  elfScrИПt[LF_FACESIZE];
}
version(Win32SansUnicode){
...
alias SID TSID;
alias SID* PSID;
alias ushort SECURITY_DESCRИПTOR_CONTROL;
alias SECURITY_DESCRИПTOR_CONTROL* PSECURITY_DESCRИПTOR_CONTROL;
alias SECURITY_DESCRИПTOR_CONTROL TSECURITYDESCRИПTORCONTROL;
alias SECURITY_DESCRИПTOR_CONTROL* PSECURITYDESCRИПTORCONTROL;

struct SECURITY_DESCRИПTOR
{
 ubyte Revision;
 ubyte Sbz1;
 SECURITY_DESCRИПTOR_CONTROL Control;
 PSID Owner;
 PSID Group;
 PACL Sacl;
 PACL Dacl;
...
alias SECURITY_DESCRИПTOR* PSECURITY_DESCRИПTOR;
alias SECURITY_DESCRИПTOR _SECURITY_DESCRИПTOR;
alias SECURITY_DESCRИПTOR TSECURITYDESCRИПTOR;
alias SECURITY_DESCRИПTOR* PSECURITYDESCRИПTOR;
...
struct JOB_INFO_2
{
 ...
 LPDEVMODE pDevMode;
 LPTSTR pStatus;
 PSECURITY_DESCRИПTOR pSecurityDescrИПtor;
 DWORD Status;
 DWORD Priority;
 DWORD Position;
 DWORD StartTime;
...
struct OUTLINETEXTMETRICA
{
 ...
 POINT   otmptSubscrИПtSize;
 POINT   otmptSubscrИПtOffset;
 POINT   otmptSuperscrИПtSize;
 POINT   otmptSuperscrИПtOffset;
...
struct RASPPPИП
{
 DWORD dwSize;
 DWORD dwError;
 TCHAR[RAS_MaxИПAddress+1] szИПAddress;
}

alias RASPPPИП _RASPPPИП;
alias RASPPPИП TRASPPPИП;
alias RASPPPИП* PRASPPPИП;

struct RASPPPИПX
{
 DWORD dwSize;
 DWORD dwError;
 TCHAR[1 + (RAS_MaxИПxAddress+1)-1] szИПxAddress;
}

alias RASPPPИПX _RASPPPИПX;
alias RASPPPИПX TRASPPPИПX;
alias RASPPPИПX* PRASPPPИПX;
...
alias NMTTDISPINFOA TOOLTИПTEXTA;
alias NMTTDISPINFOW TOOLTИПTEXTW;
version(Win32SansUnicode)
{
 alias TOOLTИПTEXTA TOOLTИПTEXT;
}
else
{
 alias TOOLTИПTEXTW TOOLTИПTEXT;
}
alias TOOLTИПTEXT* LPTOOLTИПTEXT;
alias TOOLTИПTEXT TTOOLTИПTEXT;
alias TOOLTИПTEXT* PTOOLTИПTEXT;
...
struct WIN32_Поток_ID
{
 DWORD dwПотокId;
 DWORD dwПотокAttributes;
 LARGE_INTEGER Size;
 DWORD dwПотокNameSize;
 WCHAR* cПотокName;
}

alias WIN32_Поток_ID _WIN32_Поток_ID;
alias WIN32_Поток_ID TWIN32ПотокID;
alias WIN32_Поток_ID* PWIN32ПотокID;
...
alias LAYERPLANEDESCRИПTOR* LPLAYERPLANEDESCRИПTOR;
alias LAYERPLANEDESCRИПTOR TAGLAYERPLANEDESCRИПTOR;
alias LAYERPLANEDESCRИПTOR TLAYERPLANEDESCRИПTOR;
alias LAYERPLANEDESCRИПTOR* PLAYERPLANEDESCRИПTOR;

struct PIXELFORMATDESCRИПTOR
{
 ushort nSize;
 ushort nVersion;
 DWORD dwFlags;
...
alias PIXELFORMATDESCRИПTOR* LPPIXELFORMATDESCRИПTOR;
alias PIXELFORMATDESCRИПTOR TAGPIXELFORMATDESCRИПTOR;
alias PIXELFORMATDESCRИПTOR TPIXELFORMATDESCRИПTOR;
alias PIXELFORMATDESCRИПTOR* PPIXELFORMATDESCRИПTOR;
