...
/*******************************************************************************
        ...
        don't need в_ слушай() or прими() в_ принять a datagram, and данные
        ...
        the читай() and пиши() methods will be restricted в_ a single адрес
        rather than being открой instead. That is, applying подключись() will сделай
        the адрес аргумент в_ Всё читай() and пиши() irrelevant. Without
        подключись(), метод пиши() must be supplied with an адрес and метод
        читай() should be supplied with one в_ опрentify where данные originated.
        
        Note that when used as a listener, you must first свяжи the сокет
...
class ДатаграммПровод : СокетПровод
{
        /***********************************************************************
                ...
                Create a читай/пиши datagram сокет
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                the datagram есть been подключен.

                Returns the число of байты читай в_ the вывод, or Кф if
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Чтен байты из_ an available datagram преобр_в the given Массив.
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Write the provопрed контент в_ the сокет. This will stall
                until the сокет responds in some manner. We assume the 
                datagram есть been подключен.

                Returns the число of байты sent в_ the вывод, or Кф if
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Write an Массив в_ the specified адрес. If адрес 'в_' is
                пусто, it is assumed the сокет есть been подключен instead.
        ...
        ***********************************************************************/
        ...
        т_мера пиши (проц[] ист, адрес в_)
        {
                ...
                if (ист.length)
                   {
                   счёт = (в_) ? сокет.отправь_на(ист, в_) : сокет.отправь_на(ист);
                   if (счёт <= 0)
                       счёт = Кф;
                   }
                return счёт;
