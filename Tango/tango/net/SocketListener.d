...
/******************************************************************************
        ...
        сокет. This can be used with DatagramСОКЕТ & MulticastСОКЕТ, 
        and might possibly be useful with a basic СокетПровод also.
        Note that DatagramСОКЕТ must first be bound в_ a local network
        адрес via свяжи(), and MulticastСОКЕТ should first be made a 
...
class СОКЕТListener
{
        ...
        /**********************************************************************
                ...
                метод. все аргументы are required.
        ...
        **********************************************************************/
        ...
        /***********************************************************************
                ...
                Notification обрвызов invoked whenever the listener есть
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                current читай() request responds, or is interrrupted.
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                actually interrupt a blocked читай() operation.
        ...
        private проц run ()
        {
                ...
                while (lives > 0)
                       try {
                           ...
                           // prohibits 'break' из_ exiting the try{} block
                           if (quit || 
