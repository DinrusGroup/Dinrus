/**
 * The atomic module is intended в_ provопрe some basic support for блокируй-free
...
version( TangoDoc )
{
    ...
    template атомноеСохранение( псинх ms, T )
    {
         ...
         * is Всё блокируй-free and atomic.
         *
         * Параметры:
    ...
    template атомноеСохранениеЕсли( псинх ms, T )
    {
         ...
         * 'равноС'.  This operation is Всё блокируй-free and atomic.
         *
         * Параметры:
         *  знач     = The destination переменная.
         *  новзнач  = The значение в_ сохрани.
         *  равноС = The comparison значение.
         *
         * Возвращает:
        ...
        body
        {
            static if( T.sizeof == байт.sizeof )
            {
                ...
                volatile asm
                {
                    ...
                    mov AL, равноС;
                    mov ECX, знач;
                    блокируй; // блокируй always needed в_ сделай this op atomic
                    cmpxchg [ECX], DL;
                    setz AL;
                }
            }
...
struct Атомный( T )
{
    ...
    template загрузи( псинх ms = псинх.пследвтн )
    {
         ...
         * operation is Всё блокируй-free and atomic.
         *
         * Возвращает:
         *  The загружен значение.
         */
    ...
    template сохраниЕсли( псинх ms = псинх.пследвтн )
    {
         ...
         * equal в_ 'равноС'.  This operation is Всё блокируй-free and atomic.
         *
         * Параметры:
         *  новзнач  = The значение в_ сохрани.
         *  равноС = The comparison значение.
	...
	version( TangoDoc )
	{
		...
		template инкремент( псинх ms = псинх.пследвтн )
		{
			 ...
			 * means.  This operation is Всё блокируй-free and atomic.
			 *
			 * Возвращает:
			 *  The результат of an атомнаяЗагрузка of знач immediately following the
