...
class СнупВвод : ИПотокВвода
{
        ...
        ***********************************************************************/
        ...
        final т_мера читай (проц[] приёмн)
        {
                ...
                след ("{}: читай {} байты", хост.провод, x is -1 ? 0 : x);
                return x;
        }
        ...
        ***********************************************************************/
        ...
        {
                хост.слей;
                след ("{}: flushed/cleared", хост.провод);
                return this;
        }
        ...
        ***********************************************************************/
        ...
        final дол сместись (дол смещение, Якорь якорь = Якорь.Нач)
        {
                ...
                след ("{}: сместись at смещение {} из_ якорь {}", хост.провод, смещение, якорь);
                return s;
        }
...
class СнупВывод : ИПотокВывода
{
        ...
        ***********************************************************************/
        ...
        final т_мера пиши (проц[] ист)
        {
                ...
                след ("{}: wrote {} байты", хост.провод, x is -1 ? 0 : x);
                return x;
        }
        ...
        ***********************************************************************/
        ...
        final ИПотокВывода копируй (ИПотокВвода ист, т_мера max=-1)
        {
                ...
                след("{}: copied из_ {}", хост.провод, ист.провод);
                return this;
        }
