...
class КартВвод(T) : Строки!(T)
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Load свойства из_ the provопрed поток, via a foreach.
                ...
                Note that the provопрed имя and значение are actually slices
        ...
        final цел opApply (цел delegate(ref T[] имя, ref T[] значение) дг)
        {
                ...
                foreach (строка; super)
                        ...
                        if (текст.length && (текст[0] != '#'))
                           ...
                           if (i < текст.length)
                              {
                              auto имя = Text.trim (текст[0 .. i]);
                              auto значение = Text.trim (текст[i+1 .. $]);
...
class КартВывод(T) : ФильтрВывода
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Append a нс в_ the provопрed поток
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Append a коммент в_ the provопрed поток
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Append имя & значение в_ the provопрed поток
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Append AA свойства в_ the provопрed поток
