...
/*******************************************************************************
        ...
        текст arrangement within the мишень буфер ~ one of сим, шим or
        ...
        The форматируй() метод supports the range of formatting options 
...
{       
        ...
        **********************************************************************/
        ...
        final ФормВывод выведи (...)
        {
                ...
                assert (_arguments.length <= срез.length/4, "ФормВывод :: too many аргументы");
        ...
        ***********************************************************************/
        ...
        /**********************************************************************
                ...
                flushing. An explicit слей() will always слей the вывод.
        ...
        **********************************************************************/
        ...
        private final бцел излей (T[] s)
        {
                ...
                if (счёт is Кф)
                    провод.ошибка ("ФормВывод :: unexpected Кф");
                return счёт;
        }
}
