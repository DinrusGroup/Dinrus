...
class ВводЗлиб : ФильтрВвода
{
    ...
    ***************************************************************************/
    ...
    {
        init(поток, кодировка, windowBits);
    ...
    private проц init(ИПотокВвода поток, Кодировка кодировка, цел windowBits)
    {
        ...
        // it is NOT REDUNDANT when called из_ сбрось.  источник is declared in
        // ФильтрВвода.
        //
    ...
    ***************************************************************************/ 
    ...
    {
        throw new ВВИскл("ВводЗлиб does not support сместись requests");
    }
...
class ВыводЗлиб : ФильтрВывода
{
    ...
    ***************************************************************************/
    ...
    this(ИПотокВывода поток, Уровень уровень, Кодировка кодировка,
            цел windowBits = WINDOWBITS_DEFAULT)
    {
        init(поток, уровень, кодировка, windowBits);
        scope(failure) kill_zs();
    ...
    ***************************************************************************/
    ...
    override дол сместись(дол смещение, Якорь якорь = Якорь.Нач)
    {
        throw new ВВИскл("ВыводЗлиб does not support сместись requests");
    }
...
class ИсклЗлибЕщёНеЗакрыт : ВВИскл
{
    this()
    {
        super("cannot сбрось an открой zlib поток");
    }
}
