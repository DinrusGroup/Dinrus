...
/*******************************************************************************
        ...
        LinkedFolder is производный из_ ВиртуальнаяПапка, and behaves exactly the 
...
class LinkedFolder : ВиртуальнаяПапка
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                and does not match a symbolic link, it is consопрered в_
                be неизвестное.

                We скан the установи of mounted папки, in the order mounted,
                looking for a match. Where one is найдено, we тест в_ see
...
проц main()
{
        ...
        sub.прикрепи (new ФайлПапка (r"d:/d/import/temp"));
        sub.карта (sub.файл(r"temp/subtree/тест.txt"), "wumpus");
