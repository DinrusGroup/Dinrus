...
class Md4 : MerkleDamgard
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                carried out by the padLength метод. For MD4 the добавьSize is 8.

        ***********************************************************************/

        protected override бцел добавьSize()   { return 8;  }
        ...
        ***********************************************************************/
        ...
        private static проц ff(inout бцел a, бцел b, бцел c, бцел d, бцел x, бцел s, бцел ac)
        {
                a += f(b, c, d) + x + ac;
                a = rotateLeft(a, s);
        }
        ...
        ***********************************************************************/
        ...
        private static проц gg(inout бцел a, бцел b, бцел c, бцел d, бцел x, бцел s, бцел ac)
        {
                a += g(b, c, d) + x + ac;
                a = rotateLeft(a, s);
        }
        ...
        ***********************************************************************/
        ...
        private static проц hh(inout бцел a, бцел b, бцел c, бцел d, бцел x, бцел s, бцел ac)
        {
                a += h(b, c, d) + x + ac;
                a = rotateLeft(a, s);
        }
