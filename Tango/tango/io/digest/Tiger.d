/*******************************************************************************
        ...
        This module реализует the Tiger algorithm by Ross Anderson and Eli
        Biham.
...
final class Tiger : MerkleDamgard
{
        ...
        ***********************************************************************/
        ...
        override бцел digestSize() {return 24;}
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                the minimum recommended число is 3 and this число should be
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                carried out by the padLength метод. For Tiger the добавьSize is 8.
        ...
        ***********************************************************************/
        ...
        private static проц округли(inout бдол a, inout бдол b, inout бдол c, бдол x, бдол mul)
        {
                c ^= x;
        ...
        ***********************************************************************/
        ...
        private static проц пароль(inout бдол a, inout бдол b, inout бдол c, бдол[8] x, бдол mul)
        {
        ...
        ***********************************************************************/
        ...
        private static бдол[] t1() { return table[0..256]; }
        private static бдол[] t2() { return table[256..512]; }
        private static бдол[] t3() { return table[512..768]; }
        private static бдол[] t4() { return table[768..1024]; }
}
...
private static бдол[1024] table = 
[
...
debug(UnitTest)
{
        ...
        static ткст[] strings = [
                ...
                "Tiger - A Быстрый New Hash Function, by Ross Anderson and Eli Biham",
                "Tiger - A Быстрый New Hash Function, by Ross Anderson and Eli Biham, proceedings of Быстрый Software Encryption 3, Cambrопрge.",
                "Tiger - A Быстрый New Hash Function, by Ross Anderson and Eli Biham, proceedings of Быстрый Software Encryption 3, Cambrопрge, 1996.",
        ...
        for (бцел i = 0; i < 65536; i++)
                буфер[i] = cast(ббайт) i;

                h.обнови(буфер);
                ткст e = h.гексДайджест();
