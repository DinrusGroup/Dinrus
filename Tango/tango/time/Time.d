...
/******************************************************************************
    ...
    Notably missing из_ this is a representation of weeks, месяцы and годы.
    This is because weeks, месяцы, and годы vary according в_ local calendars.
    Use time.chrono.* в_ deal with these concepts.

    Note: nobody should change this struct without really good резон as it is
    required в_ be a часть of some interfaces.  It should be treated as a
    ...
    struct with given member values (See the descrИПtion of тики() for an
...
struct ИнтервалВремени
{
        ...
        // useful constants.  Shouldn't be used in нормаль код, use the
        // static ИнтервалВремени члены below instead.  i.e. instead of
        // ИнтервалВремени.ТиковВСек, use ИнтервалВремени.сукунда.тики
        //
        enum : дол 
        {
                /// basic tick values
                ...
                ТиковВМиллисек = 1000 * TicksPerMicrosecond,
                ...
                Epoch1970           = Эпоха1601 + ТиковВСек * 11644473600L,
        }

        /**
         * Minimum ИнтервалВремени
         */
        static const ИнтервалВремени min = {дол.min};

        /**
         * Maximum ИнтервалВремени
         */
        static const ИнтервалВремени max = {дол.max};

        /**
         * Zero ИнтервалВремени.  Useful for comparisons.
         */
        static const ИнтервалВремени zero = {0};

        /**
         * Get the число of тики that this timespan represents.  This can be
         * used в_ construct другой ИнтервалВремени:
         *
         * --------
        ...
        /**
         * Determines whether two ИнтервалВремени values are equal
         */
         ...
         * Возвращает: A ИнтервалВремени значение that is the sum of this экземпляр and t.
         */
         ...
         *
         * Параметры: t = A ИнтервалВремени значение в_ добавь
         * Возвращает: a копируй of this экземпляр after добавьing t.
         */
        ...
        /**
         *
         * Subtract the specified ИнтервалВремени из_ this ИнтервалВремени and присвой the
         *
         * Параметры: t = A ИнтервалВремени в_ вычти
         ...
         * used в_ преобразуй в_ a different unit.  Use the unit accessors
         * instead.  This should only be used as a scaling mechanism.  For
         * example, if you have a таймаут and you want в_ сон for twice the
        ...
        /**
         * Scales this ИнтервалВремени and assigns the результат в_ this экземпляр.
         *
         ...
         * used в_ преобразуй в_ a different unit.  Use the unit accessors
         * instead.  This should only be used as a scaling mechanism.  For
         * example, if you have a таймаут and you want в_ сон for half the
         * таймаут, you would use таймаут / 2.
         *
         *
        ...
        /**
         * Divопрes this ИнтервалВремени and assigns the результат в_ this экземпляр.
         *
         ...
         *
         * Параметры: t = A divisor used for divопрing
         * Возвращает: The результат of целое division between this экземпляр and
         * t.
         */
        ...
        дол nanos()
        {
                return тики_ * NanosecondsPerTick;
        }
        ...
        дол micros()
        {
                return тики_ / TicksPerMicrosecond;
        }
         ...
         *
         * Возвращает: An интервал representing the сек and fractional
         ...
         */
        static ИнтервалВремени fromNanos(дол значение)
        {
                return ИнтервалВремени(значение / NanosecondsPerTick);
        }
        ...
        {
                return ИнтервалВремени(TicksPerMicrosecond * значение);
        }
         ...
         * represents сек as a дво.  This allows Всё whole and
...
/******************************************************************************
        ...
        Remarks: Время represents dates and times between 12:00:00 
        mопрnight on January 1, 10000 BC and 11:59:59 PM on December 31, 
        9999 AD.

        Время values are measured in 100-nanosecond intervals, or тики. 
        A дата значение is the число of тики that have elapsed since 
        12:00:00 mопрnight on January 1, 0001 AD in the Gregorian 
        calendar.
        
        Negative Время values are offsets из_ that same reference point, 
        but backwards in history.  Время values are not specific в_ any 
        calendar, but for an example, the beginning of December 31, 1 BC 
        in the Gregorian calendar is Время.эпоха - ИнтервалВремени.дни(1).
...
struct Время 
{
        ...
        private enum : дол
        {
                maximum = (ИнтервалВремени.ДнейНа400Лет * 25 - 366) * ИнтервалВремени.ТиковВДень - 1,
                minimum = -((ИнтервалВремени.ДнейНа400Лет * 25 - 366) * ИнтервалВремени.ТиковВДень - 1),
        }

        /// Represents the smallest and largest Время значение.
        static const Время min       = {minimum},
                          max       = {maximum};

        /// Represents the эпоха (1/1/0001)
        static const Время эпоха     = {0};

        /// Represents the эпоха of 1/1/1601 (Commonly used in Windows systems)
        static const Время эпоха1601 = {ИнтервалВремени.Эпоха1601};

        /// Represents the эпоха of 1/1/1970 (Commonly used in Unix systems)
        static const Время epoch1970 = {ИнтервалВремени.Epoch1970};

        /**********************************************************************

                $(I Property.) Retrieves the число of тики for this Время.
                This значение can be used в_ construct другой Время struct by
                writing:
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Determines whether two Время values are equal.

                Параметры:  значение = A Время _value.
                Возвращает: да if Всё instances are equal; otherwise, нет
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Возвращает: A Время that is the sum of this экземпляр and t.
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Параметры:  t = A ИнтервалВремени значение.
                Возвращает: The current Время экземпляр, with t добавьed в_ the 
                         время.
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                between this and the given Время.
        ...
        **********************************************************************/
        ...
        /**********************************************************************
                ...
                Параметры:  t = A ИнтервалВремени значение.
                Возвращает: The current Время экземпляр, with t subtracted 
                         из_ the время.
        ...
        **********************************************************************/
        ...
        Время дата () 
        {
                return *this - ВремяДня.modulo24(тики_);
        }
        ...
        **********************************************************************/
        ...
        ИнтервалВремени unix()
        {
                return ИнтервалВремени(тики_ - epoch1970.тики_);
        }
}
...
/******************************************************************************
        ...
        each component is represented within the limits of everyday время, 
        rather than из_ the старт of the Epoch. Effectively, the ВремяДня
        эпоха is the first сукунда of each день.
...
{
        /**
         * часы component of the время of день.  This should be between 0 and
         * 23, включительно.
         */
        public бцел     часы;

        /**
         * минуты component of the время of день.  This should be between 0 and
         * 59, включительно.
         */
        public бцел     минуты;

        /**
         * сек component of the время of день.  This should be between 0 and
         * 59, включительно.
         */
        public бцел     сек;
         ...
         *         миллисек = число of milliseconds преобр_в the сукунда
         *
         * Возвращает: a ВремяДня representing the given время fields.
         *
         * Note: There is no verification of the range of values, or
         * normalization made.  So if you пароль in larger values than the
         * maximum значение for that field, they will be stored as that значение.
         *
         * example:
         * --------------
        ...
        /**
         * construct a ИнтервалВремени из_ the current fields
         *
         * Возвращает: a ВремяДня representing the field values.
         *
         * Note: that fields are not checked against a valid range, so
         * настройка 60 for минуты is allowed, and will just добавь 1 в_ the час
         * component, and установи the минута component в_ 0.  The результат is
         ...
         */
        package static ИнтервалВремени modulo24 (дол тики)
        {
...
/******************************************************************************
    ...
    Combination of a Date and a ВремяДня

******************************************************************************/

struct ДатаВремя
{
        public Date         дата;       /// дата representation
...
debug (UnitTest)
{
        unittest
        {
                assert(ИнтервалВремени.zero > ИнтервалВремени.min);
                assert(ИнтервалВремени.max  > ИнтервалВремени.zero);
                assert(ИнтервалВремени.max  > ИнтервалВремени.min);
                assert(ИнтервалВремени.zero >= ИнтервалВремени.zero);
                assert(ИнтервалВремени.zero <= ИнтервалВремени.zero);
                assert(ИнтервалВремени.max >= ИнтервалВремени.max);
                assert(ИнтервалВремени.max <= ИнтервалВремени.max);
                assert(ИнтервалВремени.min >= ИнтервалВремени.min);
                assert(ИнтервалВремени.min <= ИнтервалВремени.min);
