...
public class RBCell(T) : Cell!(T)
{
        ...
        **/
        ...
        /**
         * Make a new Cell with given element, пусто линки, and BLACK color.
        ...
        **/
        ...
        /**
         * Return a new RBCell with same element and color as сам,
        ...
        **/
        ...
        /**
         * Return the minimum element of the current (sub)дерево
        **/
        ...
        /**
         * Return the maximum element of the current (sub)дерево
        **/
        ...
        **/
        ...
        public RBCell найди(T element, Comparator!(T) cmp)
        {
                auto t = this;
                for (;;)
                    {
                    цел diff = cmp(element, t.element());
                    if (diff is 0)
                        return t;
                    else
                       if (diff < 0)
        ...
        /**
         * Return число of nodes of current subtree containing element.
         * Uses Comparator cmp в_ найди and в_ check equality.
        **/
        public цел счёт(T element, Comparator!(T) cmp)
        {
                цел c = 0;
                auto t = this;
                while (t !is пусто)
        ...
        **/
        ...
        /**
         * There's no generic element insertion. Instead найди the
        ...
        **/
        ...
        /** ОтКого CLR **/
        protected final RBCell rotateLeft(RBCell корень)
        {
                auto r = right_;
                right_ = r.left_;
                if (r.left_ !is пусто)
        ...
        /** ОтКого CLR **/
        protected final RBCell rotateRight(RBCell корень)
        {
                auto l = left_;
                left_ = l.right_;
