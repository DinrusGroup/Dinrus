...
public class ArrayIterator(T) : GuardIterator!(T)
{
        ...
        /**
         * Build an enumeration that returns successive elements of the Массив
        **/
        public this (T масс[])
        {
        ...
        /**
         * Implements util.collection.impl.Collection.CollectionIterator.remaining
        ...
        **/
        public T получи()
        {
                ...
                throw new NoSuchElementException ("Exhausted Обходчик");
        }
