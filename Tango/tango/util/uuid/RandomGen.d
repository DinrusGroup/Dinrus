...
/** The default random UUID generator. You can установи this if you need в_ generate
  * UUIDs in другой manner and already have код pointing в_ this module.
  *
  * This uses a unique PRNG экземпляр. If you want repeatable results, you
  * should инъекцируй your own UUID generator and reseed it as necessary:
  * ---
  * auto случ = getRand();
  ...
  * (I can generate 150,000 per сукунда on my machine) and есть a дол период.
  * The KISS generator can произведи 5 million per сукунда on my machine.
  */
УуидГен randUuопр;
