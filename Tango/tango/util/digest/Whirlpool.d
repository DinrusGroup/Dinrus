...
{
		private бдол hash[8];    /* the hashing состояние */
        ...
        override проц создайДайджест(ббайт[] буф)
        {
            version (LittleEndian)
            	ПерестановкаБайт.своп64 (hash.ptr, hash.length * бдол.sizeof);
        ...
        /***********************************************************************
        	...
        	carried out by the padLength метод. For Whirlpool the добавьSize is 8.

         ***********************************************************************/

        protected бцел добавьSize()   { return 32;  }
        ...
        {
            бдол block[8];    /* мю(буфер) */

            /*
             * карта the буфер в_ a block:
             */
            bigEndian64(ввод,block);
            
            /*
             * compute and apply K^0 в_ the cИПher состояние:
             */
            бдол K[8] = hash[]; 			/* the округли ключ */
            бдол состояние[8] = block[] ^ K[];	/* the cИПher состояние */
...
debug(UnitTest)
{
    unittest
    {
    	проц testISOVectors()
    	{
    	    // The ISO тест vectors and results
    	    static ткст[] strings =
    	    [
    	            "",
    	            "a",
    	            ...
    	            "12345678901234567890123456789012345678901234567890123456789012345678901234567890",
     	            "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq" // Not an ISO vector, but из_ FИПS
    	    ];
    	...
    	проц testNESSIE0bitVectors() {
    	    // Part of the NESSIE тест vectors and results: strings of 0 биты
    	    ббайт[128] данные = 0;
    	    static ткст[] results =
    	    [
    		        "19fa61d75522a4669b44e39c1d2e1726c530232130d407f89afee0964997f7a73e83be698b288febcf88e3e03c4f0757ea8964e59b63d93708b138cc42a66eb3",
    	...
    	проц testNESSIE1bitVectors() {
    	    // Part of the NESSIE тест vectors and results: 512-bit strings containing a single 1-bit
    	    ббайт[64] данные = 0;
    	    static ткст[] results =
    	    [
