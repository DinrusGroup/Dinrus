...
final class Ripemd256 : MerkleDamgard
{
        ...
        ***********************************************************************/
        ...
        override бцел digestSize() {return 32;}
        ...
        /***********************************************************************
        	...
        	carried out by the padLength метод. For Ripemd256 the добавьSize is 8.
        ...
        protected override проц трансформируй(ббайт[] ввод)
        {
            ...
            // Do not своп dl and dr; simply добавь the right значение в_ контекст 
