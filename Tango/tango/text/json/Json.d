...
/*******************************************************************************
        ...
        Constructing json within your код leverages a handful of factories 
        within a document экземпляр. This example creates a document из_ an 
        Массив of values:
        ---
        auto json = new Json!(сим);
        ...
        // {"a" : 10}
        with (json)
              значение = объект (pair("a", значение(10)));
        ---
        ...
        // {"a" : 10, "b" : да}
        with (json)
              значение = объект (pair("a", значение(10)), pair("b", значение(да)));
        ---

        Substitute массивы, or другой objects as values where appropriate:
        ---
        // {"a" : [10, да, {"b" : пусто}]}
        with (json)
              значение = объект (pair("a", Массив(10, да, объект(pair("b")))));
        ---

        TODO: document как в_ extract контент
...
class Json(T) : private JsonParser!(T)
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Parse the given текст and return a resultant Значение тип. Also
        ...
        ***********************************************************************/
        ...
        final Значение значение (дво v)
        {
         ...
         /***********************************************************************
                 ...
                 Create a single Значение из_ an Массив of Values
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Create an attribute/значение pair, where значение defaults в_ 
                пусто

        ***********************************************************************/
        
        Атрибут pair (T[] имя, Значение значение = пусто)
        {
        ...
        /***********************************************************************
                ...
                Create a composite из_ zero or ещё pairs, and return as 
                a значение
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Internal factory в_ создай values

        ***********************************************************************/
        
        private Значение создайЗначение ()
        {
                return values.размести.сбрось;
        }
        ...
        private Composite разбериОбъект ()
        {
                ...
                while (super.следщ) 
                      ...
                      if (super.текТип != Токен.Name)
                          super.ожидалось ("an attribute-имя", super.ткт.ptr);
                        
                      auto имя = super.значение;
                        
                      if (! super.следщ)
                            super.ожидалось ("an attribute-значение", super.ткт.ptr);
        ...
        ***********************************************************************/
        ...
        private Значение[] разбериМассив ()
        {
                if (nesting >= массивы.length)
                    исключение ("Массив nesting too deep within document");
        ...
        /***********************************************************************
                ...
                Represents an attribute/значение pair. Aliased as Атрибут
        ...
        ***********************************************************************/
        ...
        struct NameValue
        {
                ...
                /***************************************************************
                        ...
                        Набор a имя and a значение for this attribute
        ...
        struct JsonObject
        {
                ...
                ***************************************************************/
                ...
                /***************************************************************
                        ...
                        Append an attribute/значение pair
                ...
                ***************************************************************/
                ...
                /***************************************************************
                        ...
                        Construct and return a hashmap of Объект атрибуты.
        ...
        ***********************************************************************/
        ...
        struct JsonValue
        {
                ...
                public Тип тип;               /// the тип of this node
                alias сбрось установи;                /// alternate имя for сбрось

                /***************************************************************
        
                        return да if this node is of the given тип
                ...
                ***************************************************************/
                ...
                Значение установи (T[] ткт, бул escaped = нет)
                {
                ...
                ***************************************************************/
                ...
                /***************************************************************
                        ...
                        Набор this значение в_ represent an Массив of values.
                ...
                ***************************************************************/
                ...
                /***************************************************************
                        ...
                        Набор a variety of values преобр_в an Массив тип
                        ...
                        foreach (тип; инфо)
                                ...
                                if (тип is typeid(Значение))
                                   ...
                                   if (тип is typeid(проц*))
                                      ...
                                      хост.исключение ("JsonValue.установи :: unexpected тип: "~тип.вТкст);
                                   }
                                список ~= v;
                                }
        ...
        ***********************************************************************/
        ...
        private struct Разместитель(T)
        {
                ...
                проц сбрось ()
                {
                        // discard since prior lists are not инициализован
                        lists.length = 0;       
                        block = -1;
                        newlist;
                }
        ...
        /***********************************************************************
                ...
                Internal use for parsing Массив values
...
debug (UnitTest)
{
        ...
        with (new Json!(сим))
             ...
             корень = объект
                  (
                  pair ("edgar", значение("friendly")),
                  pair ("счёт", значение(11.5)),
                  pair ("Массив", значение(Массив(1, 2)))
                  );
        ...
        unittest
        {
        // check with a разделитель of the tab character
        with (new Json!(сим))
             {
             корень = объект
                  (
        ...
        unittest
        {
        // check with a разделитель of five пробелы
        with (new Json!(дим))
             {
             корень = объект
                  ( 
...
debug (Json)
{
        ...
        проц main()
        {
                ...
                with (p)
                      значение = объект(pair("a", Массив(пусто, да, нет, 30, объект(pair("foo")))), pair("b", значение(10)));
                ...
                with (new Json!(сим))
                     {
                     корень = объект(pair("Массив", Массив(пусто)));
