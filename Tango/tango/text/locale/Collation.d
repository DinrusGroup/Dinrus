...
public class СтрокоСопоставитель {
  ...
  /**
    ...
    Параметры:
      культура = A Культура экземпляр whose rules are used в_ compare strings.
  ...
  */
  ...
  /**
    Compares two strings and returns the сортируй order.
    Возвращает:
      -1 is strA is less than strB; 0 if strA is equal в_ strB; 1 if strA is greater than strB.
    Параметры:
      strA = A ткст в_ compare в_ strB.
      strB = A ткст в_ compare в_ strA.
  */
  public цел compare(ткст strA, ткст strB) {
  ...
  /**
    ...
    Возвращает:
      да if strA and strB are equal; otherwise, нет.
    Параметры:
      strA = A ткст в_ compare в_ strB.
      strB = A ткст в_ compare в_ strA.
  */
  ...
  /**
    $(I Property.) Retrieves an экземпляр that performs case-sensitive comparisons using the rules of the current культура.
    Возвращает:
      A new СтрокоСопоставитель экземпляр.
  */
  public static СтрокоСопоставитель текущаяКультура() {
    return new СтрокоСопоставитель(Культура.current, нет);
  }

  /**
    $(I Property.) Retrieves an экземпляр that performs case-insensitive comparisons using the rules of the current культура.
    Возвращает:
      A new СтрокоСопоставитель экземпляр.
  */
  public static СтрокоСопоставитель currentCultureIgnoreCase() {
    return new СтрокоСопоставитель(Культура.current, да);
  }
...
/**
  ...
  Remarks:
    The delegate есть the сигнатура $(I цел delegate(ткст, ткст)).
 */
...
public class СтрокоСортировщик {
  ...
  */
  ...
  /**
    Sorts все the elements in an Массив.
    Параметры:
  ...
  */
  ...
  /**
    Sorts a range of the elements in an Массив.
    Параметры:
      Массив = The Массив of strings в_ _sort.
      индекс = The starting индекс of the range.
      счёт = The число of elements in the range.
  */
  ...
  /**
    $(I Property.) Retrieves an экземпляр that performs a case-sensitive сортируй using the rules of the current культура.
  ...
  */
  ...
  /**
    $(I Property.) Retrieves an экземпляр that performs a case-insensitive сортируй using the rules of the current культура.
    Возвращает: A СтрокоСортировщик экземпляр.
  */
