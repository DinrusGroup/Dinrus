/**
 * Модуль Массив предоставляет процедуры манипуляции Массивами, пытаясь
 * сохранить баланс производительности и гибкости. Операции для сортировки
 * и обработки как сортированных, так и несортированных массивов.
 */
module core.Array;
