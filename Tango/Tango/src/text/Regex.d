/*******************************************************************************
    ...
    The время for совпадают a regular expression against an ввод ткст of length N is in O(M*N), where M depends on the
    число of совпадают brackets и the complexity of the expression. That is, M is constant wrt. the ввод
    и therefore совпадают is a linear-время process.

    The syntax of a regular expressions is as follows.
    <i>X</i> и <i>Y</i> stand for an arbitrary regular expression.
...
/* ************************************************************************************************
    Represents a class of characters as использован in regular expressions (e.g. [0-9a-z], etc.)
**************************************************************************************************/
