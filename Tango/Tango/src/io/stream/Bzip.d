...
class БзипВывод : ФильтрВывода
{
    ...
    ***************************************************************************/
    ...
    т_мера пиши(проц[] ист)
    {
        ...
        assert( bzs.avail_in == 0, "не удалось сжать предоставленные данные" );
    ...
    ***************************************************************************/
    ...
    {
        throw new ВВИскл("БзипВывод не поддерживает запросы сместиться");
    }
...
class ИсклЗакрытБзип : ВВИскл
{
    ...
    this()
    {
        super("не возможна операция с закрытым потоком bzip2");
    }
}
...
class ИсклБзипЕщёНеЗакрыт : ВВИскл
{
    ...
    this()
    {
        super("не удаётся переустановить открытый поток bzip2");
    }
}
