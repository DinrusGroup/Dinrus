...
public import sys.DConsts:МАСКА_ВВПАРАМ, ВВК_ВХО, ВВФСБВВ, СОКОШИБ, ПОпцияСокета, ППротокол, ПТипСок, ПСемействоАдресов, ПЭкстрЗакрытиеСокета, ПФлагиСокета, ПФлагиАИ, ПОшибкаАИ,  ПФлагиУИ, ПИмИнфо;


public import sys.DStructs: ВИНСОКДАН, ВИНСОКБУФ, набор_уд, значврем, хостзап, адрессок, заминка, адрес_ин, протзап, служзап, адринфо;
        ...
        ***********************************************************************/ 
        ...
        { 
                ...
                version (Win32) 
                        { 
                        if (!getAddrinfo) 
                           { // *old* windows, let's fall back куда НетХост 
