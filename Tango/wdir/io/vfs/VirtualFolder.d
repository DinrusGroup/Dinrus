...
class ВиртуальнаяПапка : ХостВфс
{
        ...
        ***********************************************************************/
        ...
        ХостВфс открепи (ПапкаВфс папка)
        {
                ...
                // проверь this is a ветвь, и locate the mapped имя
...
/*******************************************************************************
        ...
        A установи of virtual папки. For a подст-дерево, we compose the results 
...
private class ВиртуальныеПапки : ПапкиВфс
{
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Созд a папка группа включая the provопрed папка и
