/*******************************************************************************
        ...
        length-префикс, and should otherwise be explicitly managed at
...
/*******************************************************************************
        ...
        A simple way в_ читай binary данные из_ an arbitrary ИПотокВвода,
        such as a файл:
        ---
        auto ввод = new ВводДанных (new Файл ("путь"));
        auto x = ввод.цел32;
        auto y = ввод.плав64;
        auto l = ввод.читай (буфер);           // читай необр данные directly
...
class ВводДанных : ФильтрВвода
{
        ...
        ***********************************************************************/
        ...
        this (ИПотокВвода поток)
        {
                ...
                разместитель = (бцел байты){return new проц[байты];};
        }

        /***********************************************************************

                Набор the массив разместитель
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                установи current эндиан translation
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                Чтен an массив back преобр_в a пользователь-provопрed workspace. The
        ...
        ***********************************************************************/
        ...
        final бцел массив (проц[] приёмн)
        {
                ...
                if (длин > приёмн.length)
                    провод.ошибка ("ВводДанных.читайМассив :: приёмн массив is too small");
        ...
        /***********************************************************************
                ...
                Чтен an массив back из_ the источник, with the assumption
                it есть been записано using ВыводДанных.помести() or otherwise
                ...
                the provопрed delegate, or из_ the куча, populated and
        ...
        ***********************************************************************/
        ...
        private final проц съешь (ук  приёмн, т_мера байты)
        {
                while (байты)
                      ...
                      if (i is Кф)
                          ввод.провод.ошибка ("ВводДанных :: unexpected eof while reading");
                      байты -= i;
                      приёмн += i;
                      } 
         }
