...
public struct РасширеннаяДата {
    ...
    */
   бцел сек() { return знач.время.сек + ((маска >>> 0) & 1); }
    ...
    */
   бул конецДня() { return 1 ==              ((маска >>> 1) & 1); }

   private проц установиВисокосный    () { маска |= 1 << 0; }
   private проц установиКонецДня() { маска |= 1 << 1; }
...
debug (UnitTest) {
   ...
   debug (Tango_ISO8601_Valgrind) import cidrus : malloc, free;
