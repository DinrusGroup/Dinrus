...
*/
	бцел ДайТекущуюПапку(бцел длинаБуфера, ткст буфер);
/**
CreateDirectoryA
*/
...
*/
	...
	бул СоздайПроцесс(ткст назвПриложения, ткст комСтр, БЕЗАТРЫ* атрыПроц, БЕЗАТРЫ* атрыНити, бул наследоватьДескр, ПФлагСоздПроц флаги , ук среда, ткст текПап, ИНФОСТАРТА* ис, ИНФОПРОЦ* пи);  //ЮНИКОД
