...
template изБокса(T : кплав)
{
    T изБокса(Бокс значение)
    {
        return разбоксКастКомплекс!(T) (значение);
    }
}
template изБокса(T : кдво)
{
    T изБокса(Бокс значение)
    {
        return разбоксКастКомплекс!(T) (значение);
...
template изБокса(T : вплав)
{
    T изБокса(Бокс значение)
    {
        return разбоксКастМнимое!(T) (значение);
    }
}
template изБокса(T : вдво)
{
    T изБокса(Бокс значение)
    {
        return разбоксКастМнимое!(T) (значение);
