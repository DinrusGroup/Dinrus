...
import exception, cidrus,  tpl.args;
import std.format, std.string, std.utf, std.format, std.file, std.crc32;
import sys.WinFuncs, win: скажинс;
...
export extern (D) abstract class Поток :  sys.WinIfaces.ПотокВвода,sys.WinIfaces.ПотокВывода
 {
extern(C) extern
{
      шим[] возврат;
