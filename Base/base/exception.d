...
*/
////////////////////////////////////////////////////////////////////////////////
export extern(D) class ИсключениеЗагрузкиБиблиотеки: Исключение
{

    ткст м_назвСовмБиб;
export:
 проц выведи(in ткст[] назвыБиб, in ткст[] причины)
    {
 ...
 this(ткст сообщ)
    {
	this.м_назвСовмБиб = "";
        super(сообщ,__FILE__, __LINE__);
    }

 this(ткст сообн, ткст назвСовмБиб)
    {
	this.м_назвСовмБиб = назвСовмБиб;
        super(сообн,__FILE__, __LINE__);
...
export extern(D) class ИсключениеНеверногоУкНаБиб: Исключение
{
export:
    ...
    this(ткст назвСовмБиб)
    {
        ...
        super("Попытка применить указатель на незагруженную ДЛЛ " ~ назвСовмБиб,__FILE__, __LINE__);
