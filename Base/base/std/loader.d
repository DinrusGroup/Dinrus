...
module std.loader;
	import  exception, cidrus,win, std.io, std.process, std.string, std.file;
...
body
{
    ...
    if(хэндл is null)
        throw new ИсключениеЗагрузкиБиблиотеки("Не удалось загрузить библиотеку " ~ имяб ~ ": " ~ дайТкстОшибки());
...
body
{
  ...
  ИсключениеЗагрузкиБиблиотеки и = new  ИсключениеЗагрузкиБиблиотеки("Ошибка:");
