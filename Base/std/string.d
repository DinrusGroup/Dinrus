...
pure nothrow unittest
{
    ...
    debug(string) эхо("string.toStringz.unittest\n");
...
{
    import std.conv : to;
    debug(string) эхо("string.indexOf.unittest\n");
...
{
    import std.conv : to;
    debug(string) эхо("string.indexOf(startIdx).unittest\n");
...
{
    import std.conv : to;
    debug(string) эхо("string.lastIndexOf.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.indexOfAny.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.indexOfAny(startIdx).unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.lastIndexOfAny.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.lastIndexOfAny(index).unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.indexOfNeither(index).unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.lastIndexOfNeither.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.lastIndexOfNeither(index).unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.splitLines.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.lineSplitter.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.strip.unittest\n");
...
unittest
{
    ...
    debug(string) эхо("string.chomp.unittest\n");
    string s;
...
unittest
{
    ...
    debug(string) эхо("string.chop.unittest\n");
...
unittest
{
    ...
    debug(string) эхо("string.justify.unittest\n");
...
@trusted pure unittest
{
    ...
    debug(string) эхо("string.detab.unittest\n");
...
unittest
{
    ...
    debug(string) эхо("string.entab.unittest\n");
...
@safe pure @nogc unittest
{
    ...
    debug(string) эхо("std.string.inPattern.unittest\n");
...
@safe pure @nogc unittest
{
    ...
    debug(string) эхо("std.string.count.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("std.string.removechars.unittest\n");
...
@trusted pure unittest
{
    ...
    debug(string) эхо("std.string.squeeze.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("std.string.succ.unittest\n");
...
unittest
{
    ...
    debug(string) эхо("std.string.tr.unittest\n");
    import std.algorithm : equal;
...
@trusted unittest
{
    ...
    debug(string) эхо("isNumeric(in string, bool = false).unittest\n");
...
@trusted pure unittest
{
    ...
    debug(string) эхо("string.abbrev.unittest\n");
...
@safe @nogc unittest
{
    ...
    debug(string) эхо("string.column.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.wrap.unittest\n");
 ...
 *
 * Throws:
 *     ТкстИск if indentation is done with different sequences
...
S[] outdent(S)(S[] lines) @safe pure if(isSomeString!S)
{
    ...
    foreach (ref line; lines)
    {
        ...
        {
            throw new ТкстИск("outdent: Inconsistent indentation");
        }
    }
...
@safe pure unittest
{
    ...
    debug(string) эхо("string.outdent.unittest\n");
