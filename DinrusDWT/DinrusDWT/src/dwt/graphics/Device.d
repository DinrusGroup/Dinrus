...
public abstract class Device : Drawable
{
    ...
    */
    ...
    public Color getSystemColor (int id)
    {
        ...
        switch (id)
        {
        case DWT.COLOR_WHITE:
            pixel = 0x00FFFFFF;
            break;
        case DWT.COLOR_BLACK:
            pixel = 0x00000000;
            break;
        case DWT.COLOR_RED:
            pixel = 0x000000FF;
            break;
        case DWT.COLOR_DARK_RED:
            pixel = 0x00000080;
            break;
        case DWT.COLOR_GREEN:
            pixel = 0x0000FF00;
            break;
        case DWT.COLOR_DARK_GREEN:
            pixel = 0x00008000;
            break;
        case DWT.COLOR_YELLOW:
            pixel = 0x0000FFFF;
            break;
        case DWT.COLOR_DARK_YELLOW:
            pixel = 0x00008080;
            break;
        case DWT.COLOR_BLUE:
            pixel = 0x00FF0000;
            break;
        case DWT.COLOR_DARK_BLUE:
            pixel = 0x00800000;
            break;
        case DWT.COLOR_MAGENTA:
            pixel = 0x00FF00FF;
            break;
        case DWT.COLOR_DARK_MAGENTA:
            pixel = 0x00800080;
            break;
        case DWT.COLOR_CYAN:
            pixel = 0x00FFFF00;
            break;
        case DWT.COLOR_DARK_CYAN:
            pixel = 0x00808000;
            break;
        case DWT.COLOR_GRAY:
            pixel = 0x00C0C0C0;
            break;
        case DWT.COLOR_DARK_GRAY:
            pixel = 0x00808080;
            break;
        default:
        }
