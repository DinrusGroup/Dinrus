...
public final class Cursor : Resource
{
    ...
    public this(Device device, int style)
    {
        ...
        switch (style)
        {
        case DWT.CURSOR_HAND:
            lpCursorName = OS.IDC_HAND;
            break;
        case DWT.CURSOR_ARROW:
            lpCursorName = OS.IDC_ARROW;
            break;
        case DWT.CURSOR_WAIT:
            lpCursorName = OS.IDC_WAIT;
            break;
        case DWT.CURSOR_CROSS:
            lpCursorName = OS.IDC_CROSS;
            break;
        case DWT.CURSOR_APPSTARTING:
            lpCursorName = OS.IDC_APPSTARTING;
            break;
        case DWT.CURSOR_HELP:
            lpCursorName = OS.IDC_HELP;
            break;
        case DWT.CURSOR_SIZEALL:
            lpCursorName = OS.IDC_SIZEALL;
            break;
        case DWT.CURSOR_SIZENESW:
            lpCursorName = OS.IDC_SIZENESW;
            break;
        case DWT.CURSOR_SIZENS:
            lpCursorName = OS.IDC_SIZENS;
            break;
        case DWT.CURSOR_SIZENWSE:
            lpCursorName = OS.IDC_SIZENWSE;
            break;
        case DWT.CURSOR_SIZEWE:
            lpCursorName = OS.IDC_SIZEWE;
            break;
        case DWT.CURSOR_SIZEN:
            lpCursorName = OS.IDC_SIZENS;
            break;
        case DWT.CURSOR_SIZES:
            lpCursorName = OS.IDC_SIZENS;
            break;
        case DWT.CURSOR_SIZEE:
            lpCursorName = OS.IDC_SIZEWE;
            break;
        case DWT.CURSOR_SIZEW:
            lpCursorName = OS.IDC_SIZEWE;
            break;
        case DWT.CURSOR_SIZENE:
            lpCursorName = OS.IDC_SIZENESW;
            break;
        case DWT.CURSOR_SIZESE:
            lpCursorName = OS.IDC_SIZENWSE;
            break;
        case DWT.CURSOR_SIZESW:
            lpCursorName = OS.IDC_SIZENESW;
            break;
        case DWT.CURSOR_SIZENW:
            lpCursorName = OS.IDC_SIZENWSE;
            break;
        case DWT.CURSOR_UPARROW:
            lpCursorName = OS.IDC_UPARROW;
            break;
        case DWT.CURSOR_IBEAM:
