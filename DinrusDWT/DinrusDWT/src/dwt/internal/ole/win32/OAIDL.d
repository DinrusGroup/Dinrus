...
// in tango.sys.win32.Types
    ...
    struct VARIANT
    {
        ...
        LONG lVal()
        {
            return n1.n2.n3.lVal;
        }
        void lVal(LONG val)
        {
            return n1.n2.n3.lVal = val;
        }
        FLOAT fltVal()
        {
            return n1.n2.n3.fltVal;
        }
        void fltVal(FLOAT val)
        {
            return n1.n2.n3.fltVal = val;
        }
        IDispatch pdispVal()
        {
            return n1.n2.n3.pdispVal;
        }
        void pdispVal(IDispatch val)
        {
            n1.n2.n3.pdispVal = val;
        }
        IUnknown punkVal()
        {
            return n1.n2.n3.punkVal;
        }
        void punkVal(IUnknown val)
        {
            n1.n2.n3.punkVal = val;
        }
        VARIANT_BOOL boolVal()
        {
            return n1.n2.n3.boolVal;
        }
        void boolVal(VARIANT_BOOL val)
        {
            n1.n2.n3.boolVal = val;
        }
        SHORT iVal()
        {
            return n1.n2.n3.iVal;
        }
        void iVal(SHORT val)
        {
            n1.n2.n3.iVal = val;
        ...
        BSTR bstrVal()
        {
            return n1.n2.n3.bstrVal;
        }
        void bstrVal(BSTR val)
        {
            n1.n2.n3.bstrVal = val;
        }
