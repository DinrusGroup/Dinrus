...
//PORTING_TODO
    ...
    override public Color getSystemColor (int id)
    {
        ...
        case DWT.COLOR_TITLE_BACKGROUND_GRADIENT:
            ...
            break;
        case DWT.COLOR_TITLE_INACTIVE_FOREGROUND:
            ...
            case DWT.MouseWheel:
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                        case 1:
                            inputs.dwFlags = type is DWT.MouseDown ? OS.MOUSEEVENTF_LEFTDOWN : OS.MOUSEEVENTF_LEFTUP;
                            break;
                        case 2:
                            inputs.dwFlags = type is DWT.MouseDown ? OS.MOUSEEVENTF_MIDDLEDOWN : OS.MOUSEEVENTF_MIDDLEUP;
                            break;
                        case 3:
                            inputs.dwFlags = type is DWT.MouseDown ? OS.MOUSEEVENTF_RIGHTDOWN : OS.MOUSEEVENTF_RIGHTUP;
                            break;
                        case 4:
                        {
                            if (OS.WIN32_VERSION < OS.VERSION (5, 0)) return false;
