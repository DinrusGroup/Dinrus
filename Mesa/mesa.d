...
/////glut
 ...
 проц глутИниц(цел* а= пусто, сим** б = пусто){ glutInit( а,  б);}
 ...
 проц  глуОрто2М(дво лев, дво прав, дво низ, дво верх)
	{gluOrtho2D (cast(GLdouble) лев, cast(GLdouble) прав, cast(GLdouble) низ, cast(GLdouble) верх);}
 ...
 */
 ...
 проц  glClearIndex( GLfloat к );
 проц  glClearColor( GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha );
 проц  glClear( GLbitfield маска );
 проц  glIndexMask( GLuint маска );
 ...
 проц  glPolygonStipple(  GLubyte *маска );
 проц  glGetPolygonStipple( GLubyte *маска );
 ...
 проц  glPushAttrib( GLbitfield маска );
 проц  glPopAttrib();
 проц  glPushClientAttrib( GLbitfield маска );  /* 1.1 */
 ...
 */
 ...
 проц  glIndexd( GLdouble к );
 проц  glIndexf( GLfloat к );
 проц  glIndexi( GLint к );
 проц  glIndexs( GLshort к );
 проц  glIndexub( GLubyte к );  /* 1.1 */

 проц  glIndexdv(  GLdouble *к );
 проц  glIndexfv(  GLfloat *к );
 проц  glIndexiv(  GLint *к );
 проц  glIndexsv(  GLshort *к );
 проц  glIndexubv(  GLubyte *к );  /* 1.1 */
 ...
 проц  glTexCoord1d( GLdouble т );
 проц  glTexCoord1f( GLfloat т );
 проц  glTexCoord1i( GLint т );
 проц  glTexCoord1s( GLshort т );

 проц  glTexCoord2d( GLdouble т, GLdouble t );
 проц  glTexCoord2f( GLfloat т, GLfloat t );
 проц  glTexCoord2i( GLint т, GLint t );
 проц  glTexCoord2s( GLshort т, GLshort t );

 проц  glTexCoord3d( GLdouble т, GLdouble t, GLdouble r );
 проц  glTexCoord3f( GLfloat т, GLfloat t, GLfloat r );
 проц  glTexCoord3i( GLint т, GLint t, GLint r );
 проц  glTexCoord3s( GLshort т, GLshort t, GLshort r );

 проц  glTexCoord4d( GLdouble т, GLdouble t, GLdouble r, GLdouble q );
 проц  glTexCoord4f( GLfloat т, GLfloat t, GLfloat r, GLfloat q );
 проц  glTexCoord4i( GLint т, GLint t, GLint r, GLint q );
 проц  glTexCoord4s( GLshort т, GLshort t, GLshort r, GLshort q );
 ...
 */
 ...
 проц  glEdgeFlagPointer( GLsizei stride,  GLvoid *укз );
 проц  glGetPointerv( GLenum pname, GLvoid **парамы );
 проц  glArrayElement( GLint и );
 ...
 */
 ...
 проц  glStencilFunc( GLenum func, GLint reference, GLuint маска );

 проц  glStencilMask( GLuint маска );

 проц  glStencilOp( GLenum fail, GLenum zfail, GLenum zpass );

 проц  glClearStencil( GLint т );
 ...
 */
 ...
 проц  glEvalPoint1( GLint и );

 проц  glEvalPoint2( GLint и, GLint j );
 ...
 */
 ...
 проц  glMultiTexCoord1d( GLenum цель, GLdouble т );

 проц  glMultiTexCoord1dv( GLenum цель,  GLdouble *v );

 проц  glMultiTexCoord1f( GLenum цель, GLfloat т );

 проц  glMultiTexCoord1fv( GLenum цель,  GLfloat *v );

 проц  glMultiTexCoord1i( GLenum цель, GLint т );

 проц  glMultiTexCoord1iv( GLenum цель,  GLint *v );

 проц  glMultiTexCoord1s( GLenum цель, GLshort т );

 проц  glMultiTexCoord1sv( GLenum цель,  GLshort *v );

 проц  glMultiTexCoord2d( GLenum цель, GLdouble т, GLdouble t );

 проц  glMultiTexCoord2dv( GLenum цель,  GLdouble *v );

 проц  glMultiTexCoord2f( GLenum цель, GLfloat т, GLfloat t );

 проц  glMultiTexCoord2fv( GLenum цель,  GLfloat *v );

 проц  glMultiTexCoord2i( GLenum цель, GLint т, GLint t );

 проц  glMultiTexCoord2iv( GLenum цель,  GLint *v );

 проц  glMultiTexCoord2s( GLenum цель, GLshort т, GLshort t );

 проц  glMultiTexCoord2sv( GLenum цель,  GLshort *v );

 проц  glMultiTexCoord3d( GLenum цель, GLdouble т, GLdouble t, GLdouble r );

 проц  glMultiTexCoord3dv( GLenum цель,  GLdouble *v );

 проц  glMultiTexCoord3f( GLenum цель, GLfloat т, GLfloat t, GLfloat r );

 проц  glMultiTexCoord3fv( GLenum цель,  GLfloat *v );

 проц  glMultiTexCoord3i( GLenum цель, GLint т, GLint t, GLint r );

 проц  glMultiTexCoord3iv( GLenum цель,  GLint *v );

 проц  glMultiTexCoord3s( GLenum цель, GLshort т, GLshort t, GLshort r );

 проц  glMultiTexCoord3sv( GLenum цель,  GLshort *v );

 проц  glMultiTexCoord4d( GLenum цель, GLdouble т, GLdouble t, GLdouble r, GLdouble q );

 проц  glMultiTexCoord4dv( GLenum цель,  GLdouble *v );

 проц  glMultiTexCoord4f( GLenum цель, GLfloat т, GLfloat t, GLfloat r, GLfloat q );

 проц  glMultiTexCoord4fv( GLenum цель,  GLfloat *v );

 проц  glMultiTexCoord4i( GLenum цель, GLint т, GLint t, GLint r, GLint q );

 проц  glMultiTexCoord4iv( GLenum цель,  GLint *v );

 проц  glMultiTexCoord4s( GLenum цель, GLshort т, GLshort t, GLshort r, GLshort q );
 ...
 проц  glMultiTexCoord1dARB(GLenum цель, GLdouble т);
 проц  glMultiTexCoord1dvARB(GLenum цель,  GLdouble *v);
 проц  glMultiTexCoord1fARB(GLenum цель, GLfloat т);
 проц  glMultiTexCoord1fvARB(GLenum цель,  GLfloat *v);
 проц  glMultiTexCoord1iARB(GLenum цель, GLint т);
 проц  glMultiTexCoord1ivARB(GLenum цель,  GLint *v);
 проц  glMultiTexCoord1sARB(GLenum цель, GLshort т);
 проц  glMultiTexCoord1svARB(GLenum цель,  GLshort *v);
 проц  glMultiTexCoord2dARB(GLenum цель, GLdouble т, GLdouble t);
 проц  glMultiTexCoord2dvARB(GLenum цель,  GLdouble *v);
 проц  glMultiTexCoord2fARB(GLenum цель, GLfloat т, GLfloat t);
 проц  glMultiTexCoord2fvARB(GLenum цель,  GLfloat *v);
 проц  glMultiTexCoord2iARB(GLenum цель, GLint т, GLint t);
 проц  glMultiTexCoord2ivARB(GLenum цель,  GLint *v);
 проц  glMultiTexCoord2sARB(GLenum цель, GLshort т, GLshort t);
 проц  glMultiTexCoord2svARB(GLenum цель,  GLshort *v);
 проц  glMultiTexCoord3dARB(GLenum цель, GLdouble т, GLdouble t, GLdouble r);
 проц  glMultiTexCoord3dvARB(GLenum цель,  GLdouble *v);
 проц  glMultiTexCoord3fARB(GLenum цель, GLfloat т, GLfloat t, GLfloat r);
 проц  glMultiTexCoord3fvARB(GLenum цель,  GLfloat *v);
 проц  glMultiTexCoord3iARB(GLenum цель, GLint т, GLint t, GLint r);
 проц  glMultiTexCoord3ivARB(GLenum цель,  GLint *v);
 проц  glMultiTexCoord3sARB(GLenum цель, GLshort т, GLshort t, GLshort r);
 проц  glMultiTexCoord3svARB(GLenum цель,  GLshort *v);
 проц  glMultiTexCoord4dARB(GLenum цель, GLdouble т, GLdouble t, GLdouble r, GLdouble q);
 проц  glMultiTexCoord4dvARB(GLenum цель,  GLdouble *v);
 проц  glMultiTexCoord4fARB(GLenum цель, GLfloat т, GLfloat t, GLfloat r, GLfloat q);
 проц  glMultiTexCoord4fvARB(GLenum цель,  GLfloat *v);
 проц  glMultiTexCoord4iARB(GLenum цель, GLint т, GLint t, GLint r, GLint q);
 проц  glMultiTexCoord4ivARB(GLenum цель,  GLint *v);
 проц  glMultiTexCoord4sARB(GLenum цель, GLshort т, GLshort t, GLshort r, GLshort q);
