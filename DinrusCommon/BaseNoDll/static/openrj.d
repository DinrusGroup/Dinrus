...
//эхо("ИсклБД(0: %.*s, %.*s)\n", детали, openrj.вТкст(рк));
        ...
        ткст  сооб    =   фм(   "Создание базы данных неудачно; ошибка: %s, %s"
                                                ,   cast(цел)рк
                                                ,   openrj.вТкст(рк));
...
//эхо("ИсклБД(1: %.*s, %d)\n", openrj.вТкст(рк), номСтр);
        ...
        ткст  сооб    =   фм(   "Создание базы данных неудачно, строка %s; ошибка: %s, %s"
                                                ,   номСтр
                                                ,   cast(цел)рк
                                                ,   openrj.вТкст(рк));
...
//эхо("ИсклБД(2: %.*s, %d)\n", openrj.вТкст(pe), номСтр);
        ...
        ткст  сооб    =   фм(   "Ошибка разбора в базе данных, строка %s; ошибка парсинга: %s, %s"
                                                ,   номСтр
                                                ,   cast(цел)pe
                                                ,   openrj.вТкст(pe));
...
//эхо("ИсклБД(3: %.*s, %.*s, %d)\n", детали, openrj.вТкст(рк), номСтр);
        ...
        ткст  сооб    =   фм(   "Ошибка разбора в базе данных, строка %s; ошибка парсинга: %s, %s; %s"
                                                ,   номСтр
                                                ,   cast(цел)pe
                                                ,   openrj.вТкст(pe)
                                                ,   детали);
        ...
        foreach(Запись запись; m_records)
        {
            ...
            if(null !is поле)
            {
                ...
                if(ОРДЖ_ФЛАГ.УПОРЯДОЧИТЬ_ПОЛЯ == (флаги & ОРДЖ_ФЛАГ.УПОРЯДОЧИТЬ_ПОЛЯ))
                {
                    ...
                    {
                        цел res =   сравни(поле.имя, имяПоля);
