...
public import sys.WinStructs, std.string:
фм;
...
//............................
    ...
    проц точкаУ(цел which, Точка v)
    {
        ...
        case 1:
            поз = Точка(v.ш, v.в - высота + 1);
            break; // this bottom-left == v
        case 9:
            поз = Точка(v.ш - ширина + 1, v.в);
            break; // this top-right == v
        case 8:
            поз = Точка(v.ш - ширина / 2, v.в);
            break; // this top-middle == v
        case 2:
            поз = Точка(v.ш - ширина / 2, v.в - высота + 1);
            break; // this bottom-middle == v
        case 4:
            поз = Точка(v.ш, v.в - высота / 2);
            break; // this center-left == v
        case 6:
            поз = Точка(v.ш - ширина + 1, v.в - высота / 2);
            break; // this center-right == v
        case 5:
            поз = Точка(v.ш - ширина / 2, v.в - высота / 2);
