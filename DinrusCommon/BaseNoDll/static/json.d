...
class ТкстДжейСОН:ТипДжейСОН
{
    ...
    {
        _данные = кодируйДжейСОН(данные);
    }
    /// Allow the данные to be retreived.
    ткст дай()
    {
        return раскодируйДжейСОН(_данные);
    }
...
unittest
{
    ...
    {
        /*shazam! program flow should дай here, it is a correct thing*/
    }
}
