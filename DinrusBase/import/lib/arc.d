...
extern (D) struct Точка
{
    ...
    бул над(Точка Другая);
    бул под(Точка Другая);
    бул справа(Точка Другая);
    бул слева(Точка Другая);
}
...
extern (D):
    ...
    проц рисуйКруг(Точка поз, плав радиус, цел деталь, Цвет цв, бул залить);
    проц рисуйПрямоуг(Точка поз, Размер разм, Цвет цв, бул залить);
    проц рисуйМногоуг(Точка[] многоуг, Цвет цв, бул залить);
