...
class БуфВвод : ФильтрВвода, БуферВвода
{
        ...
        alias ФильтрВвода.ввод ввод;          /// доступ к источнику 

        private проц[]        данные;             // буфер необр данных
        private т_мера        индекс;            // текущ позиция чтения
        private т_мера        протяженность;           // предел действителного контента
...
public alias БуфВвод  Бввод;        /// удовный алиас
public alias БуфВывод Бвыв;       /// уже сказано
