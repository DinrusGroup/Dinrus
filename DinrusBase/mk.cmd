...
@set common=%DINRUS%\..\dev\DINRUS\DinrusCommon
...
:copy %this%\src\sys\WinConsts.d %this%\import\sys\WinConsts.d 
:copy %this%\src\sys\WinStructs.d %this%\import\sys\WinStructs.d 
:copy %this%\src\sys\WinTypes.d %this%\import\sys\WinTypes.d 
:copy %this%\src\sys\WinIfaces.d %this%\import\sys\WinIfaces.d 
:copy %this%\src\base.d %this%\import\base.d
...
:::%this%\base\io\*d %this%\src\io\device\*.d %this%\src\io\stream\*.d
:::%LS% -d %this%\src\io\*d %this%\src\io\device\*.d %this%\src\io\stream\*.d 
%LS% -d %this%\src\std\*.d %this%\src\*.d %this%\src\tpl\*.d %this%\src\rt\*.d %this%\src\sys\*.d %this%\src\sys\inc\*.d>>%this%\objs.rsp
...
%DMD%  -c -O  -g -of%this%\ini.obj %common%\static\ini.d -I%R%
...
%DMD%  -c -O  -g -of%this%\rotozoom.obj %common%\static\rotozoom.d -I%R%
%DMD%  -c -O  -g -of%this%\msscript.obj %common%\static\msscript.d DRwin32.lib -I%R%
%DMD%  -c -O  -g -of%this%\activex.obj %common%\static\activex.d DRwin32.lib -I%R%
%DMD%  -c -O  -g -of%this%\json.obj %common%\static\json.d -I%R%

::Special configuration items
%DMD%  -c -O  -g -of%this%\base.obj %common%\static\base.d -I%R%
%DMD%  -c -O  -g -of%this%\exeMain.obj %common%\static\exeMain.d -I%R%
...
%DMD%  -c -O  -g -of%this%\comsys.obj %common%\static\sys0\com.d -I%R%
...
:%DMD%  -c -O  -g  %common%\static\lib\mesa.d mesa.lib
...
:Col
%LS% -d %common%\static\col\*.d  %common%\static\col\model\*.d>>%this%\col.rsp
...
:Util
%LS% -d %common%\static\util\*.d>>%this%\ut.rsp
...
:LinAlg
%LS% -d %common%\static\linalg\*.d>>%this%\la.rsp
...
:Mesh
%LS% -d %common%\static\mesh\*.d>>%this%\mesh.rsp
...
:St
%LS% -d %common%\static\st\*.d>>%this%\st.rsp
...
:Geom
%LS% -d %common%\static\geom\*.d>>%this%\geom.rsp
...
%DMD%  -lib  -of%this%\DinrusSpecBuild.lib %common%\static\dllMain.d
