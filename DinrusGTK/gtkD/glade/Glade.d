...
public class Glade : ObjectG
{
    ...
    Widget newFromWidget(GtkWidget* ptr)
    {
        ...
        {
        case "GtkAboutDialog":
            return new AboutDialog(cast(GtkAboutDialog *)ptr);
        case "GtkAccelLabel":
            return new AccelLabel(cast(GtkAccelLabel *)ptr);
        case "GtkAlignment":
            return new Alignment(cast(GtkAlignment *)ptr);
        case "GtkArrow":
            return new Arrow(cast(GtkArrow *)ptr);
        case "GtkAspectFrame":
            return new AspectFrame(cast(GtkAspectFrame *)ptr);
        case "GtkAssistant":
            return new Assistant(cast(GtkAssistant *)ptr);
        case "GtkBin":
            return new Bin(cast(GtkBin *)ptr);
        case "GtkBox":
            return new Box(cast(GtkBox *)ptr);
        case "GtkButtonBox":
            return new ButtonBox(cast(GtkButtonBox *)ptr);
        case "GtkButton":
            return new Button(cast(GtkButton *)ptr);
        case "GtkCalendar":
            return new Calendar(cast(GtkCalendar *)ptr);
        case "GtkCellView":
            return new CellView(cast(GtkCellView *)ptr);
        case "GtkCheckButton":
            return new CheckButton(cast(GtkCheckButton *)ptr);
        case "GtkCheckMenuItem":
            return new CheckMenuItem(cast(GtkCheckMenuItem *)ptr);
        case "GtkColorButton":
            return new ColorButton(cast(GtkColorButton *)ptr);
        case "GtkColorSelection":
            return new ColorSelection(cast(GtkColorSelection *)ptr);
        case "GtkColorSelectionDialog":
            return new ColorSelectionDialog(cast(GtkColorSelectionDialog *)ptr);
        case "GtkComboBox":
            return new ComboBox(cast(GtkComboBox *)ptr);
        case "GtkComboBoxEntry":
            return new ComboBoxEntry(cast(GtkComboBoxEntry *)ptr);
        case "GtkContainer":
            return new Container(cast(GtkContainer *)ptr);
        case "GtkCurve":
            return new Curve(cast(GtkCurve *)ptr);
        case "GtkDialog":
            return new Dialog(cast(GtkDialog *)ptr);
        case "GtkDrawingArea":
            return new DrawingArea(cast(GtkDrawingArea *)ptr);
        case "GtkEntry":
            return new Entry(cast(GtkEntry *)ptr);
        case "GtkEventBox":
            return new EventBox(cast(GtkEventBox *)ptr);
        case "GtkExpander":
            return new Expander(cast(GtkExpander *)ptr);
        case "GtkFileChooserButton":
            return new FileChooserButton(cast(GtkFileChooserButton *)ptr);
        case "GtkFileChooserDialog":
            return new FileChooserDialog(cast(GtkFileChooserDialog *)ptr);
        case "GtkFileChooserWidget":
            return new FileChooserWidget(cast(GtkFileChooserWidget *)ptr);
        case "GtkFileSelection":
            return new FileSelection(cast(GtkFileSelection *)ptr);
        case "GtkFixed":
            return new Fixed(cast(GtkFixed *)ptr);
        case "GtkFontButton":
            return new FontButton(cast(GtkFontButton *)ptr);
        case "GtkFontSelection":
            return new FontSelection(cast(GtkFontSelection *)ptr);
        case "GtkFontSelectionDialog":
            return new FontSelectionDialog(cast(GtkFontSelectionDialog *)ptr);
        case "GtkFrame":
            return new Frame(cast(GtkFrame *)ptr);
        case "GtkGammaCurve":
            return new GammaCurve(cast(GtkGammaCurve *)ptr);
        case "GtkHandleBox":
            return new HandleBox(cast(GtkHandleBox *)ptr);
        case "GtkHBox":
            return new HBox(cast(GtkHBox *)ptr);
        case "GtkHButtonBox":
            return new HButtonBox(cast(GtkHButtonBox *)ptr);
        case "GtkHPaned":
            return new HPaned(cast(GtkHPaned *)ptr);
        case "GtkHRuler":
            return new HRuler(cast(GtkHRuler *)ptr);
        case "GtkHScale":
            return new HScale(cast(GtkHScale *)ptr);
        case "GtkHScrollbar":
            return new HScrollbar(cast(GtkHScrollbar *)ptr);
        case "GtkHSeparator":
            return new HSeparator(cast(GtkHSeparator *)ptr);
        case "GtkIconView":
            return new IconView(cast(GtkIconView *)ptr);
        case "GtkImage":
            return new Image(cast(GtkImage *)ptr);
        case "GtkImageMenuItem":
            return new ImageMenuItem(cast(GtkImageMenuItem *)ptr);
        case "GtkInputDialog":
            return new InputDialog(cast(GtkInputDialog *)ptr);
        case "GtkInvisible":
            return new Invisible(cast(GtkInvisible *)ptr);
        case "GtkItem":
            return new Item(cast(GtkItem *)ptr);
        case "GtkLabel":
            return new Label(cast(GtkLabel *)ptr);
        case "GtkLayout":
            return new Layout(cast(GtkLayout *)ptr);
        case "GtkLinkButton":
            return new LinkButton(cast(GtkLinkButton *)ptr);
        case "GtkMenuBar":
            return new MenuBar(cast(GtkMenuBar *)ptr);
        case "GtkMenu":
            return new Menu(cast(GtkMenu *)ptr);
        case "GtkMenuItem":
            return new MenuItem(cast(GtkMenuItem *)ptr);
        case "GtkMenuShell":
            return new MenuShell(cast(GtkMenuShell *)ptr);
        case "GtkMenuToolButton":
            return new MenuToolButton(cast(GtkMenuToolButton *)ptr);
        case "GtkMessageDialog":
            return new MessageDialog(cast(GtkMessageDialog *)ptr);
        case "GtkMisc":
            return new Misc(cast(GtkMisc *)ptr);
        case "GtkNotebook":
            return new Notebook(cast(GtkNotebook *)ptr);
        case "GtkPageSetupUnixDialog":
            return new PageSetupUnixDialog(cast(GtkPageSetupUnixDialog *)ptr);
        case "GtkPaned":
            return new Paned(cast(GtkPaned *)ptr);
        case "GtkPlug":
            return new Plug(cast(GtkPlug *)ptr);
        case "GtkPrintUnixDialog":
            return new PrintUnixDialog(cast(GtkPrintUnixDialog *)ptr);
        case "GtkProgressBar":
            return new ProgressBar(cast(GtkProgressBar *)ptr);
        case "GtkProgress":
            return new Progress(cast(GtkProgress *)ptr);
        case "GtkRadioButton":
            return new RadioButton(cast(GtkRadioButton *)ptr);
        case "GtkRadioMenuItem":
            return new RadioMenuItem(cast(GtkRadioMenuItem *)ptr);
        case "GtkRadioToolButton":
            return new RadioToolButton(cast(GtkRadioToolButton *)ptr);
        case "GtkRange":
            return new Range(cast(GtkRange *)ptr);
        case "GtkRecentChooserDialog":
            return new RecentChooserDialog(cast(GtkRecentChooserDialog *)ptr);
        case "GtkRecentChooserMenu":
            return new RecentChooserMenu(cast(GtkRecentChooserMenu *)ptr);
        case "GtkRecentChooserWidget":
            return new RecentChooserWidget(cast(GtkRecentChooserWidget *)ptr);
        case "GtkRuler":
            return new Ruler(cast(GtkRuler *)ptr);
        case "GtkScaleButton":
            return new ScaleButton(cast(GtkScaleButton *)ptr);
        case "GtkScale":
            return new Scale(cast(GtkScale *)ptr);
        case "GtkScrollbar":
            return new Scrollbar(cast(GtkScrollbar *)ptr);
        case "GtkScrolledWindow":
            return new ScrolledWindow(cast(GtkScrolledWindow *)ptr);
        case "GtkSeparator":
            return new Separator(cast(GtkSeparator *)ptr);
        case "GtkSeparatorMenuItem":
            return new SeparatorMenuItem(cast(GtkSeparatorMenuItem *)ptr);
        case "GtkSeparatorToolItem":
            return new SeparatorToolItem(cast(GtkSeparatorToolItem *)ptr);
        case "GtkSocket":
            return new Socket(cast(GtkSocket *)ptr);
        case "GtkSpinButton":
            return new SpinButton(cast(GtkSpinButton *)ptr);
        case "GtkStatusbar":
            return new Statusbar(cast(GtkStatusbar *)ptr);
        case "GtkTable":
            return new Table(cast(GtkTable *)ptr);
        case "GtkTearoffMenuItem":
            return new TearoffMenuItem(cast(GtkTearoffMenuItem *)ptr);
        case "GtkTextView":
            return new TextView(cast(GtkTextView *)ptr);
        case "GtkToggleButton":
            return new ToggleButton(cast(GtkToggleButton *)ptr);
        case "GtkToggleToolButton":
            return new ToggleToolButton(cast(GtkToggleToolButton *)ptr);
        case "GtkToolbar":
            return new Toolbar(cast(GtkToolbar *)ptr);
        case "GtkToolButton":
            return new ToolButton(cast(GtkToolButton *)ptr);
        case "GtkToolItem":
            return new ToolItem(cast(GtkToolItem *)ptr);
        case "GtkTreeView":
            return new TreeView(cast(GtkTreeView *)ptr);
        case "GtkVBox":
            return new VBox(cast(GtkVBox *)ptr);
        case "GtkVButtonBox":
            return new VButtonBox(cast(GtkVButtonBox *)ptr);
        case "GtkViewport":
            return new Viewport(cast(GtkViewport *)ptr);
        case "GtkVolumeButton":
            return new VolumeButton(cast(GtkVolumeButton *)ptr);
        case "GtkVPaned":
            return new VPaned(cast(GtkVPaned *)ptr);
        case "GtkVRuler":
            return new VRuler(cast(GtkVRuler *)ptr);
        case "GtkVScale":
            return new VScale(cast(GtkVScale *)ptr);
        case "GtkVScrollbar":
            return new VScrollbar(cast(GtkVScrollbar *)ptr);
        case "GtkVSeparator":
            return new VSeparator(cast(GtkVSeparator *)ptr);
        case "GtkWidget":
            return new Widget(cast(GtkWidget *)ptr);
        case "GtkWindow":
            return new Window(cast(GtkWindow *)ptr);
        default:
            return null;
        }
